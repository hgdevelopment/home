...
Route::group(['middleware' => ['admin']], function () 
{
    ...
    Route::post('hr/employee/personal/update','hr\employeeController@personal_update');
    Route::post('hr/employee/company/update','hr\employeeController@company_update');
    Route::post('hr/employee/address/update','hr\employeeController@address_update');
    Route::post('hr/employee/address/new','hr\employeeController@address_new');
    Route::post('hr/employee/skills/update','hr\employeeController@skills_update');
    Route::post('hr/employee/qualificaton/update','hr\employeeController@qualificaton_update');
    Route::post('hr/employee/certificate/update','hr\employeeController@certificate_update');
    Route::post('hr/employee/family/update','hr\employeeController@family_update');
    Route::post('hr/employee/experience/update','hr\employeeController@experience_update');
    Route::post('hr/employee/reference/update','hr\employeeController@reference_update');
    

    Route::get('hr/employee/view/{id}','hr\employeeController@view');
    Route::get('hr/employee/qualification/{id}','hr\employeeController@qualification');
    Route::get('hr/employee/certificate/{id}','hr\employeeController@certificate');
    Route::get('hr/employee/family/{id}','hr\employeeController@family');
    Route::get('hr/employee/experience/{id}','hr\employeeController@experience');
    Route::get('hr/employee/reference/{id}','hr\employeeController@reference');

    Route::get('hr/employee/datatable_employee','hr\employeeController@datatable_employee');
    

    Route::get('hr/employee/appointment_letter_view','hr\employeeController@viewAppointmentLetter'); //for apmntletter empcode enterpage
    ...
    Route::get('hr/employee/createExperience','hr\employeeController@createExperience');
    Route::post('hr/employee/createExperience','hr\employeeController@createExperience_view');
    Route::get('hr/employee/createExperience/pdf/{id}','hr\employeeController@createExperience_pdf');
    ...
    Route::resource('hr/master/holidaymaster','hr\holidayController');
    Route::resource('hr/resignation/apply_resignation', 'hr\resignationController');
    Route::resource('hr/master/religionmaster','hr\religionController');
    Route::post('hr/visitor/update_visitor','hr\visitorController@updatevisitor');
    Route::get('hr/visitor/edit_visitor_registration/{id}','hr\visitorController@editvisitor');
    Route::get('hr/visitor/view_visitor','hr\visitorController@show');
    Route::resource('hr/visitor/visitor_registration', 'hr\visitorController'); 
    Route::post('hr/resignation/view','hr\resignationController@report');
    Route::get('hr/resignation/report','hr\resignationController@view');
    Route::get('hr/resignation/deny/{id}','hr\resignationController@deny');
    Route::get('hr/resignation/approve/{id}','hr\resignationController@approve');
    Route::get('hr/resignation/view_resignation','hr\resignationController@show');
    Route::resource('hr/resignation/apply_resignation', 'hr\resignationController');
    ...
    Route::get('import/attendance','importController@home');
}); 
