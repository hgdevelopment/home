...
<div class="wrapper-md">
  <div class="row">
    <div class="col-sm-12">
      <div class="blog-post">                   
        <div class="col-sm-12">
          <form role="form" method="POST" action="<?php echo e(URL::to('/')); ?>/admin/deniedMember/<?php echo $__env->yieldContent('edit_id'); ?>" data-parsley-validate enctype="multipart/form-data">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type='text' name="dateofbirth" id="dateofbirth" readonly class="form-control" onchange="getAge()" data-language="en" value="<?php echo $__env->yieldContent('dateofbirth'); ?>"/>
                ...
                <div class="form-group col-sm-4" >
                  ...
                  <img src="<?php echo e(URL::asset('storage/img/member_img/'.$member->photo)); ?>" style="width:100px;height:100px;">
                  <input type="hidden" name="photo_update" value="<?php echo e($member->photo); ?>">
                  <?php endif; ?>
                </div>
                <div class="form-group col-sm-4">
                  ...
                  <img src="<?php echo e(URL::asset('storage/img/member_img/'.$member->singnature)); ?>" style="width:100px;height:100px;">
                  <input type="hidden" name="sign_update" value="<?php echo e($member->singnature); ?>">
                  <?php endif; ?>
                </div>
              </div>
            </div>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <div class="form-group col-sm-12">
                        <label>Address</label>
                        <textarea type="text" name="off_address"  id="off_address"  data-parsley-required-message="Please Enter Address " data-parsley-trigger="keyup"  class="form-control" style="height:5%"><?php echo $__env->yieldContent('off_address'); ?></textarea>
                      </div>
                      <div class="form-group col-sm-12">
                        <label>City</label>
                      ...
                      <div class="form-group col-sm-12">
                        <label>Pin</label>
                        <input type="text" name="offpin" id="offpin" value="<?php echo $__env->yieldContent('offpin'); ?>" data-parsley-required-message="Please Enter Pin Number" data-parsley-trigger="keyup" data-parsley-maxlength="6" data-parsley-type="integer" class="form-control" >
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="type_amount_inr" id="type_amount_inr" placeholder="INR" value="<?php echo $__env->yieldContent('type_amount_inr'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="AMOUNT APPLYING FOR" id="amount_inr" name="amount_inr" data-parsley-type="number" value="<?php echo $__env->yieldContent('amount_inr'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" name="type_amount_aed" class="form-control"  id="type_amount_aed" placeholder="AED" value="<?php echo $__env->yieldContent('type_amount_aed'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT APPLYING FOR </label>
                          <input type="text" class="form-control" placeholder="AMOUNT APPLYING FOR" id="amount_aed" name="amount_aed" data-parsley-type="number" value="<?php echo $__env->yieldContent('amount_aed'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" name="type_amount_usd" class="form-control"  id="type_amount_usd" placeholder="USD" value="<?php echo $__env->yieldContent('type_amount_usd'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT APPLYING FOR </label>
                          <input type="text" class="form-control" placeholder="AMOUNT APPLYING FOR" id="amount_usd" name="amount_usd" data-parsley-type="number" value="<?php echo $__env->yieldContent('amount_usd'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" name="type_amount_sar" class="form-control"  id="type_amount_sar" placeholder="SAR" value="<?php echo $__env->yieldContent('type_amount_sar'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT APPLYING FOR </label>
                          <input type="text" class="form-control" placeholder="AMOUNT APPLYING FOR" id="amount_sar" name="amount_sar" data-parsley-type="number"  value="<?php echo $__env->yieldContent('amount_sar'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" name="type_amount_cad" class="form-control"  id="type_amount_cad" placeholder="CAD" value="<?php echo $__env->yieldContent('type_amount_cad'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group"> 
                          <label>AMOUNT APPLYING FOR</label>
                          <input type="text" class="form-control" placeholder="AMOUNT APPLYING FOR" id="amount_cad" name="amount_cad" data-parsley-type="number" value="<?php echo $__env->yieldContent('amount_cad'); ?>">
                  ...
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <img src="<?php echo e(URL::asset('storage/img/proof/'.$memb->file)); ?>" style="width:100px;">
                        <input type="hidden" name="proof_update" value="<?php echo e($memb->file); ?>">
                        <?php endif; ?>
                      </div>
                    </div>
                  </div>
