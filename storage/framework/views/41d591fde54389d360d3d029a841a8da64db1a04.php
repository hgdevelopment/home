         ...
         <?php endif; ?>
          ...
          <div class="col-md-12">
              <div class="row">
                  ...
                  <div class="col-md-4">
                      <label>SALARY</label>
                       <input name="salary" type="text" id="salary" required data-parsley-required-message="Please Enter Salary" data-parsley-type="number"   data-parsley-maxlength="10"  class="form-control" value="<?php echo $__env->yieldContent('salary'); ?>" placeholder="Amount From" >
                  ...
                  <div class="col-md-4">
                      <label>TARGET</label>
                       <input name="target" type="text" id="target" required data-parsley-required-message="Please Enter Target" data-parsley-type="number" data-parsley-maxlength="10" class="form-control" value="<?php echo $__env->yieldContent('target'); ?>" placeholder="Target" >
                ...
                <div class="col-md-12"></div>
                  <div class="col-md-4">
                      <label>AMOUNT FROM</label>
                       <input name="fromAmount" type="text" id="fromAmount" required data-parsley-required-message="Please Enter Employee From Amount " data-parsley-type="number"  data-parsley-maxlength="10"  class="form-control" value="<?php echo $__env->yieldContent('fromAmount'); ?>" placeholder="Amount From" >
                  ...
                  <div class="col-md-4">
                      <label>TO AMOUNT</label>
                       <input name="toAmount" type="text" id="toAmount" required data-parsley-required-message="Please Enter Employee To Amount" data-parsley-type="number"  data-parsley-maxlength="10"   class="form-control" value="<?php echo $__env->yieldContent('toAmount'); ?>" placeholder="Amount To" >
