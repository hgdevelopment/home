...
<?php if($request->opcode==7): ?>
	...
	$n=$request->n;	
	 ?>
		...
		<input class="form-control" type="text"  data-date-end-date="0d<?php echo e($n); ?>" id="dob<?php echo e($n); ?>" name="dob<?php echo e($n); ?>" value="<?php if(isset($nominee->dob)): ?><?php echo e(date('d-m-Y',strtotime($nominee->dob))); ?><?php endif; ?>" required data-parsley-required-message="Please Select Correct DOB" readonly />
		...
		<select class="form-control col-md-6" name="typeOfProof<?php echo e($n); ?>" id="typeOfProof<?php echo e($n); ?>" required data-parsley-required-message="Select Proof Type">
		<option value=" ">Select</option>
		...
		<img  alt="uploadPhoto" style="width:200px;height:200px;cursor: pointer;" src="<?php echo e(URL::to('/')); ?>/storage/img/nominee/<?php echo e($nominee->uploadPhoto); ?>" onclick="window.open('<?php echo e(URL::to('/')); ?>/storage/img/nominee/<?php echo e($nominee->uploadPhoto); ?>')" download >
		</div>
		<?php endif; ?>

		<?php if(isset($nominee->signature)): ?>
		<div class="col-sm-4 nomineePhoto<?php echo e($n); ?>"><br>
		<img  alt="proofId" style="width:200px;height:200px;cursor: pointer;" src="<?php echo e(URL::to('/')); ?>/storage/img/nominee/<?php echo e($nominee->signature); ?>" onclick="window.open('<?php echo e(URL::to('/')); ?>/storage/img/nominee/<?php echo e($nominee->signature); ?>')" download>
		</div>
		<?php endif; ?>
		...
		<div class="col-sm-4 nomineePhoto<?php echo e($n); ?>"><br>
		<img  alt="Proof Copy" style="width:200px;height:200px;cursor: pointer;" src="<?php echo e(URL::to('/')); ?>/storage/img/proof/<?php echo e($proof->file); ?>" onclick="window.open('<?php echo e(URL::to('/')); ?>/storage/img/proof/<?php echo e($proof->file); ?>')" download>
		</div>
		<?php endif; ?>
		</div>
		</div>
				...
				<div id="nomineePhotos<?php echo e($n); ?>" class="row">
					<div class="col-sm-4">Upload Photo<span style="color:red;">*</span><input class="btn btn-success btn-fill removeattr<?php echo e($n); ?>" ui-jq="filestyle" ui-options="{icon: false, buttonName: 'btn m-b-xs w-xs btn-dark btn-rounded'}" type="file" name="uploadPhoto<?php echo e($n); ?>" id="uploadPhoto<?php echo e($n); ?>" <?php  
					if(!isset($Edit)) echo 'required data-parsley-required-message="Select Nominee Photo"';   ?> onchange="imageCheck(this)">
							<span class="uploadPhoto<?php echo e($n); ?> text-danger"></span> 
							<?php if($errors->has('uploadPhoto'.$n)): ?>
                  			<span class="help-inline "><?php echo e($errors->first('uploadPhoto'.$n)); ?></span>
                			<?php endif; ?>
					</div>

					<div class="col-sm-4">Signature<span style="color:red;">*</span><input class="btn btn-success btn-fill removeattr<?php echo e($n); ?>" ui-jq="filestyle" ui-options="{icon: false, buttonName: 'btn m-b-xs w-xs btn-dark btn-rounded'}" type="file" name="signature<?php echo e($n); ?>" id="signature<?php echo e($n); ?>" <?php  
					if(!isset($Edit)) echo 'required data-parsley-required-message="Select Signature Fle"';   ?> onchange="imageCheck(this)">
							<span class="signature<?php echo e($n); ?> text-danger"></span> 
							<?php if($errors->has('signature'.$n)): ?>
                  			<span class="help-inline "><?php echo e($errors->first('signature'.$n)); ?></span>
                			<?php endif; ?>
					</div>


					<div class="col-sm-4">Proof Copy<span style="color:red;">*</span><input class="btn btn-success btn-fill removeattr<?php echo e($n); ?>" ui-jq="filestyle" ui-options="{icon: false, buttonName: 'btn m-b-xs w-xs btn-dark btn-rounded'}" type="file" name="proofCopy<?php echo e($n); ?>" id="proofCopy<?php echo e($n); ?>" <?php  
					if(!isset($Edit)) echo 'required data-parsley-required-message="Select Nominee ProofCopy"';   ?> onchange="imageCheck(this)">
							<span class="proofCopy<?php echo e($n); ?> text-danger"></span> 
							<?php if($errors->has('proofCopy'.$n)): ?>
                  			<span class="help-inline "><?php echo e($errors->first('proofCopy'.$n)); ?></span>
                			<?php endif; ?>
					</div>
				</div> 	<div class="col-sm-12">&nbsp;</div>
		<?php  
...
<span style="width: 100px;height: 25px;padding-bottom: 22px;padding-top: 0px;" class="btn btn-<?php echo $color;?>"><?php echo e($detail->docVerified); ?></span>

<!-- <div class="text-center btn btn-default" style=" color: #ffffff; width: 130px;height: 25px;padding-bottom: 22px;padding-top: 0px;background:<?php if($detail->docVerified=='Pending'): ?><?php echo e('#e88606'); ?><?php elseif($detail->docVerified=='Verified'): ?><?php echo e('#63ce63'); ?><?php endif; ?>">
...
<span style="width: 100px;height: 25px;padding-bottom: 22px;padding-top: 0px;" class="btn btn-<?php echo $color;?>"><?php echo e($detail->status); ?></span><br>
...
<?php if($detail->status=='Denied' && Controller::UserAccessRights('TCN Reapproval')=='1'): ?>
<li>
