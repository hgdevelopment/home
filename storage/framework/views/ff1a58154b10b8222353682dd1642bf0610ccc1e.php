    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="col-sm-4 col-sm-offset-5">
          ...
          <?php endif; ?>
          <a href="<?php echo e(URL::to('/')); ?>/admin/dsa/app/editDsa/<?php echo e($dsaDetails->userId); ?>"  class="active"><button type="button" class="btn btn-info" name="edit" id="edit">Edit</button></a>
          <?php if($dsaDetails->status=='Denied'): ?>
          <a onclick="deleted11(<?php echo e($dsaDetails->userId); ?>)"> <button type="button" class="btn btn-danger" id="remove">Remove</button></a>
          <?php endif; ?>
        </div>
