          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="input-group m-b"> 
                ...
                <input type="text" placeholder="Income" id="income" name="income" value="<?php echo e(old('income')); ?>" class="form-control" required  data-parsley-trigger="keyup" data-parsley-type="number" data-parsley-required-message="Please Enter Income" data-parsley-min="1">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="Pin" data-parsley-trigger="keyup" required data-parsley-maxlength="6" data-parsley-minlength="1" data-parsley-type="integer" data-parsley-required-message="Please Enter Valid Pin number" data-parsley-minlength-message="Please enter valid pin" id="permanent_pin" name="permanent_pin" value="<?php echo e(old('permanent_pin')); ?>">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
          ...
          <textarea type="text" class="form-control" required data-parsley-required-message="Please enter address" placeholder="Address" id="correspondance_addr" name="correspondance_addr"><?php echo e(old('correspondance_addr')); ?></textarea>
        ...
        <div class="form-group">
          <label>City<span style="color:red;">*</span></label>
          <input type="text" class="form-control" placeholder="City" required data-parsley-required-message="Please enter city" required id="correspondance_city" name="correspondance_city" value="<?php echo e(old('correspondance_city')); ?>">
        ...
        <div class="form-group">
          <label>State<span style="color:red;">*</span></label>
          <input type="text" class="form-control" placeholder="State" data-parsley-required-message="Please enter state" required data-parsley-pattern="^[A-Z a-z]*$" data-parsley-trigger="keyup" id="correspondance_state" name="correspondance_state" value="<?php echo e(old('correspondance_state')); ?>">
        ...
        <div class="form-group">
          <label>Pin<span style="color:red;">*</span></label>
          <input type="text" id="correspondance_pin" name="correspondance_pin" class="form-control" required data-parsley-maxlength="6" data-parsley-minlength="1" data-parsley-minlength-message="Please enter valid pin" data-parsley-required-message="Please Enter valid Pin number" data-parsley-trigger="keyup" placeholder="Pin" data-parsley-type="integer"  value="<?php echo e(old('correspondance_pin')); ?>">
  ...
  <div class="col-sm-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <label>Pin</label>
          <input type="text" class="form-control" data-parsley-maxlength="6" data-parsley-minlength="1" data-parsley-minlength-message="Please enter valid pin" data-parsley-required-message="Please Enter valid pin" data-parsley-trigger="keyup" placeholder="Pin" id="official_pin" name="official_pin" data-parsley-type="integer" value="<?php echo e(old('official_pin')); ?>">
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group" >
              ...
              <option value="ME" <?php echo e((old('assign_member')=='ME')?'selected':''); ?>>ME</option>
              </select>
          ...
          <div class="col-sm-6" id="me">
            <div class="form-group">
              ...
              <?php if($errors->has('mename')): ?>
              <span class="help-inline"><?php echo e($errors->first('mename')); ?></span>
              <?php endif; ?>
            </div>
          </div>
        </div> 
