...
<div style="color:black;background:<?php if($detail->status=='Applied'): ?><?php echo e('yellow'); ?><?php elseif($detail->status=='Approved'): ?><?php echo e('#63ce63'); ?><?php else: ?> <?php echo e('#f67979'); ?><?php endif; ?>">
	...
	<div class="btn-group dropdown">
	  ...
	  <ul class="dropdown-menu  dropdown-menu-right">
	    <li>
	  	...
	  	<?php if($detail->status=='Applied'): ?>
	    <li>
			<a href="<?php echo e(URL::to('/')); ?>/admin/normalWithDraw/<?php echo e($detail->tcnId); ?>">Approve</a>
	    </li>
	    <li>
			<a onclick="DenyRequest('<?php echo e($detail->tcnId); ?>','<?php echo e($detail->withDrawId); ?>')">Deny</a>
	    </li>
	    <?php endif; ?>
	  </ul>
	</div>
