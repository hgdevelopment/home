...
<br>
<form action="<?php echo e(URL::to('/')); ?>/admin/dsaApprove/<?php echo $__env->yieldContent('edit_id'); ?>" method="post" data-parsley-validate enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group">
			              ...
			              <input type="hidden" id="conId" name="conId" value="<?php echo $__env->yieldContent('mobileId'); ?>" class="input-group-addon conId form-control">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Deposit Date" name="depositDate" required data-parsley-required-message="Please Select Date"  id="depositDate" value="<?php echo $__env->yieldContent('depositDate'); ?>"  data-date-end-date="0d" readonly="">
