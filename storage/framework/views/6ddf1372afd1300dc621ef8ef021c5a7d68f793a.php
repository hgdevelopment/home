                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" data-parsley-type="number" name="type_amount_inr" id="type_amount_inr" placeholder="INR" value="<?php echo $__env->yieldContent('type_amount_inr'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" class="form-control" data-parsley-type="number" name="type_amount_aed" id="type_amount_aed" placeholder="AED" value="<?php echo $__env->yieldContent('type_amount_aed'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" class="form-control" data-parsley-type="number" name="type_amount_usd"  id="type_amount_usd" placeholder="USD" value="<?php echo $__env->yieldContent('type_amount_usd'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" class="form-control" data-parsley-type="number" name="type_amount_sar" id="type_amount_sar" placeholder="SAR" value="<?php echo $__env->yieldContent('type_amount_sar'); ?>">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" class="form-control" name="type_amount_cad" data-parsley-type="number" id="type_amount_cad" placeholder="CAD" value="<?php echo $__env->yieldContent('type_amount_cad'); ?>">
