			...
			<div class="panel-body">
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-4">
							<?php if(isset($Edit)): ?>
							<img src="<?php echo e(URL::to('/')); ?>/storage/img/tcndocs/<?php echo e($Edit['doc1']); ?>" style="height:200px;width:200px;cursor: pointer;"  onclick="window.open('<?php echo e(URL::to('/')); ?>/storage/img/tcndocs/<?php echo e($Edit['doc1']); ?>')">
							<?php endif; ?>
						...
						<div class="col-sm-4">
							<?php if(isset($Edit)): ?>
							<img src="<?php echo e(URL::to('/')); ?>/storage/img/tcndocs/<?php echo e($Edit['doc2']); ?>" style="height:200px;width:200px;cursor: pointer;"  onclick="window.open('<?php echo e(URL::to('/')); ?>/storage/img/tcndocs/<?php echo e($Edit['doc2']); ?>')">
							<?php endif; ?>
						...
						<div class="col-sm-4">
							<?php if(isset($Edit)): ?>
							<img src="<?php echo e(URL::to('/')); ?>/storage/img/tcndocs/<?php echo e($Edit['doc3']); ?>" style="height:200px;width:200px;cursor: pointer;"  onclick="window.open('<?php echo e(URL::to('/')); ?>/storage/img/tcndocs/<?php echo e($Edit['doc3']); ?>')">
							<?php endif; ?>
