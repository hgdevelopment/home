...
while($i<20){
echo '<option style="background:#ffeeb5;" value="'.carbon::now()->addMonths($i)->format('Y/m').'">'.carbon::now()->addMonths($i)->format('F Y').'</option>'; 
$i++;
}
 ?>
</select><br>
...
<a href="<?php echo e(URL::to('/')); ?>/admin/benefit" class="btn btn-dark" id="back" style="float: left;">Back</a>
...
<p id="statusajax<?php echo e($tcnmasters->id); ?>" style="padding: 0px 0px 2px 15px;text-align: right;"></p>
            ...
            success: function(result){
               if(result != 0){
                ...
                if(result.status == '2' || result.status == '3'){
                     ...
                     $( '#statusajax<?php echo e($tcnmasters->id); ?>' ).html( "<span style='color:red;'>Benefit Generated already</span>" );
...
$('#update<?php echo e($tcnmasters->id); ?>').click(function(event) {
   ...
   var a = $('#inr<?php echo e($tcnmasters->id); ?>').val();
   var b = $('#aed<?php echo e($tcnmasters->id); ?>').val();
   var c = $('#sar<?php echo e($tcnmasters->id); ?>').val();
   var d = $('#usd<?php echo e($tcnmasters->id); ?>').val();
   var e = $('#cad<?php echo e($tcnmasters->id); ?>').val(); 
   
   if(a > 0){$('#inrnote<?php echo e($tcnmasters->id); ?>').html('');}else{$('#inrnote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter INR amount</span>');$('#update<?php echo e($tcnmasters->id); ?>').removeClass('animated bounce infinite');return;}
    if(b > 0){$('#aednote<?php echo e($tcnmasters->id); ?>').html(''); }else{$('#aednote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter AED amount</span>');$('#update<?php echo e($tcnmasters->id); ?>').removeClass('animated bounce infinite');return;}
     if(c  > 0){ $('#sarnote<?php echo e($tcnmasters->id); ?>').html('');}else{$('#sarnote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter SAR amount</span>');$('#update<?php echo e($tcnmasters->id); ?>').removeClass('animated bounce infinite');return;}
      if(d  > 0){ $('#usdnote<?php echo e($tcnmasters->id); ?>').html('');}else{$('#usdnote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter USD amount</span>');$('#update<?php echo e($tcnmasters->id); ?>').removeClass('animated bounce infinite');return;}
       if(e  > 0){$('#cadnote<?php echo e($tcnmasters->id); ?>').html(''); }else{$('#cadnote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter CAD amount</span>');$('#update<?php echo e($tcnmasters->id); ?>').removeClass('animated bounce infinite');return;}
...
$('#submit<?php echo e($tcnmasters->id); ?>').click(function(event) {
   ...
   if(a > 0){$('#inrnote<?php echo e($tcnmasters->id); ?>').html('');}else{$('#inrnote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter INR amount</span>');return;}
    if(b > 0){$('#aednote<?php echo e($tcnmasters->id); ?>').html(''); }else{$('#aednote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter AED amount</span>');return;}
     if(c  > 0){ $('#sarnote<?php echo e($tcnmasters->id); ?>').html('');}else{$('#sarnote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter SAR amount</span>');return;}
      if(d  > 0){ $('#usdnote<?php echo e($tcnmasters->id); ?>').html('');}else{$('#usdnote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter USD amount</span>');return;}
       if(e  > 0){$('#cadnote<?php echo e($tcnmasters->id); ?>').html(''); }else{$('#cadnote<?php echo e($tcnmasters->id); ?>').html('<span style="color:red;">Please enter CAD amount</span>');return;}
