    ...
    <div class="row m-t">
      ...
      <?php echo e(csrf_field()); ?>
        ...
        <div class="col-sm-12">
          ...
          <img src="<?php echo e(URL::asset('storage/img/member_img/'.$member->singnature)); ?>" draggable="true"  class="img-thumbnail " alt="" style="width: 100px;height:130px;" /><span style="margin-left: 30px;">PROOF</span><br> <span class="h6-text text-black" style="text-transform: uppercase;">Proof Type : &nbsp;<?php echo e($proof->typeOfProof); ?></span><br> <span class="h6-text text-black" style="text-transform: uppercase;">ID Number : &nbsp;<?php echo e($proof->proofNumber); ?></span></a>
          ...
          <div class="clear m-b">
            ...
            <span class="text-black name_text_sub" style="text-transform: uppercase;"><?php echo e($member->countryNames); ?></span>
            </div>
          </div>
          <a href="#" class="pop3">
  ...
  <div class="row" style="padding-bottom: 20PX;">
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body">
          ...
          <?php if(($Address->typeOfAddress=='permanent')&&($ctryname->type=='permanent')): ?>
    ...
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body">
          <?php $__currentLoopData = $countryaddress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctryname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php $__currentLoopData = $address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if(($Address->typeOfAddress=='correspondance')&&($ctryname->type=='correspondance')): ?>
          <div class="col-md-12 col-xs-12 divTableCell">Address <b class="data-lab"><?php echo e($Address->address); ?></b></div>
          <div class="col-md-12 col-xs-12 divTableCell">City<b class="data-lab"><?php echo e($Address->city); ?></b></div>
          <div class="col-md-12 col-xs-12 divTableCell">State<b class="data-lab"> <?php echo e($Address->state); ?></b></div>
          <div class="col-md-12 col-xs-12 divTableCell">Country<b class="data-lab"><?php echo e($ctryname->Names); ?></b></div>
    ...
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body"> 
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">INR</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($member->membership_details)->inr->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($member->membership_details)->inr->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">AED</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($member->membership_details)->aed->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($member->membership_details)->aed->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">USD</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($member->membership_details)->usd->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($member->membership_details)->usd->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">SAR</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($member->membership_details)->sar->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($member->membership_details)->sar->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">CAD</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($member->membership_details)->cad->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($member->membership_details)->cad->amount); ?> </div>
        </div>
      </div>
    </div>
  </div>
