	      ...
	      <div class="row">
	          ...
	          <div class="col-sm-4">
	            <div class="form-group">
	              ...
	              <input type="file" class="form-control" id="profilepic" name="profilepic" accept="image/png,image/jpeg" onchange="imageCheck(this)">
	          ...
	          <div class="col-sm-4">
	            <div class="form-group" style="float:left;">
	              ...
	              <input type="file" class="form-control" id="signature" name="signature" accept="image/png,image/jpeg" onchange="imageCheck(this)">
	        ...
	        <div class="col-sm-4">
	          <div class="form-group">
	            <input type="hidden" name="proofCopy1" value="<?php echo e($proofs->file); ?>">	
	            ...
	            <input type="file" class="form-control" placeholder="Proof File" id="proof_file" name="proof_file" onchange="imageCheck(this)">
	      ...
	      <div class="panel-body">
			    <div class="row">
			      <div class="col-sm-4">Nominee Name<span style="color:red;">*</span>
			        <input type="text" name="name" id="name" value="" class="form-control"     required data-parsley-required-message="Enter Nominee Name"  data-parsley-trigger="keyup" data-parsley-pattern-message="Dont Enter Special Charecters or Numbers" data-parsley-pattern="/^[^-\s][a-zA-Z_ ]*$/"/>
			      </div>
			   ...
			   <div class="col-sm-12"><br></div>
			    ...
			    <div class="row">
			      <div class="col-sm-4">Address<span style="color:red;">*</span>
			        <textarea class="form-control" id="naddress" name="naddress"  data-parsley-trigger="keyup" rows="1" required data-parsley-required-message="Enter Correct Address" data-parsley-trigger="keyup" data-parsley-minlength="20"></textarea>
			      </div>

			      <div class="col-sm-4">City<span style="color:red;">*</span>
			        <input type="text" name="city" id="city" class="form-control" value=""   required data-parsley-required-message="Enter City" />
			      </div>

			      <div class="col-sm-4">State<span style="color:red;">*</span>
			        <input type="text" name="state" id="state" class="form-control" value=""    required data-parsley-required-message="Enter State"/>
			      </div>
			   ...
			   <div class="col-sm-12"><br></div>
			    ...
			    <div class="row">
			      ...
			      <div class="col-sm-4">proof Number
			        <input type="text" name="proofNumber" id="proofNumber" value="" class="form-control"  />
			      </div>
			      <div class="col-sm-4">Pin<span style="color:red;">*</span>
			        <input class="form-control" placeholder="Pin" required data-parsley-required-message="Please Enter Pin Number" data-parsley-trigger="keyup" name="pin" id="pin" type="text" value=""  data-parsley-pattern="^[1-9][0-9]{4,5}$">
			      </div>
			      <div class="col-sm-12"><br></div>
