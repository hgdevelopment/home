  ...
  <div class="wrapper-lg bg-white-opacity">
    <div class="row m-t">
      <div class="col-sm-12">
          ...
          <img src="<?php echo e(URL::asset('storage/img/payProof/'.$dsapaymentdetails->file)); ?>" draggable="true"  class="img-thumbnail " alt="" style="width: 100px;height:130px;" /><span style="margin-left: 30px;">PROOF</span><br> <span class="h6-text text-black" style="text-transform: uppercase;">Proof Type : &nbsp;<?php echo e($dsaProof->typeOfProof); ?></span><br> <span class="h6-text text-black" style="text-transform: uppercase;">ID No : &nbsp;<?php echo e($dsaProof->proofNumber); ?></span></a>
...
<div class="col-sm-6">
  ...
  <div class="col-sm-12"></div>
  <?php if($dsaDetails->status=="Active"): ?>
  <div class="col-sm-12">
    <div class="panel panel-warning">
      <div class="panel-heading font-bold">Action</div>
      <div class="panel-body">
        <div class="col-sm-4 col-sm-offset-5">
          <a onclick="destroy(<?php echo e($dsaDetails->userId); ?>)"> <button type="button" class="btn btn-danger" name="remove" id="remove">Remove</button></a>
          <a href="<?php echo e(URL::to('/')); ?>/admin/dsa/UpdateApproveDsa/<?php echo e($dsaDetails->userId); ?> "  class="active"><button type="button" class="btn btn-info" name="edit" id="edit">Edit</button></a>
...
<script type="text/javascript">
    ...
    if (isConfirm) {
    $.ajax({
    url: "<?php echo e(URL::to('admin/delete/blocklist')); ?>",
    type: "get",
    ...
    setTimeout(function() {
    window.location.href = "<?php echo e(URL::to('admin/dsa/viewApproveDsa')); ?>";
    }, 2000);
    },
