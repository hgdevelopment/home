					...
					<div class="col-md-12">
				        ...
				        <div class="row">
				           ...
				           <div class="col-md-4">
				              ...
				              <input class="form-control"  id="openOn" name="openOn" value="<?php if(isset($Edit['openOn'])): ?><?php echo e(date('d-m-Y',strtotime($Edit['openOn']))); ?><?php endif; ?><?php echo e(old('openOn')); ?>" required="" data-parsley-required-message="Select Open On Date"  type="text">
				            </div>
