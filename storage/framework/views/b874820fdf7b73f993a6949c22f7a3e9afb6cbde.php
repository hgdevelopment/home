...
function transferTcn(tcnId)
{

var nominee=$('#nominee'+tcnId).val();

      swal({
        title: "Confirm",
        text: "Are you sure, you want to transfer this TCN",
        type: "info",
      ...
      function (isConfirm) 
      {
        ...
        {	
			...
			window.location.assign("<?php echo e(URL::to('/')); ?>/admin/tcnTransfer/Show@"+tcnId+"@"+nominee);
        }
        else
        {
          return ;
