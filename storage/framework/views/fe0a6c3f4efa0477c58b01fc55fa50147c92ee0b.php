      ...
      <div class="panel panel-warning">
        ...
        <table class="table table-striped m-b-none" style="background: #f3f3f3;">
          <tbody>
            ...
            <td>Signature</td>
              <th >
               <img src="<?php echo e(URL::asset('/storage/img/member_img/'.$userProfile->singnature)); ?>" class="img-thumbnail" alt="" style="width: 100px;" />
              </th> 
            </tr>
          </tbody>
        </table>
        ...
        <table class="table table-striped m-b-none" style="    background: #f3f3f3;">
          ...
          <tbody>
            ...
            <tr>   
              ...
              <td>Proof Image</td>
              <th>
               <img src="<?php echo e(URL::asset('/storage/img/proof/'.$userProfile->proof->file)); ?>" class="img-thumbnail" alt="" style="width: 100px;" />
