...
<div class="wrapper-md" ng-controller="FormDemoCtrl">
  <form role="form" method="post" action="<?php echo e(URL::to('/')); ?>/admin/tcnTransfer" enctype="multipart/form-data" id="form" data-parsley-validate>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type='text' name="dateofbirth" id="dateofbirth" readonly  class="form-control"  value="<?php echo e(date('d-m-Y',strtotime($nominees->dob))); ?>"/>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <select  class="form-control chosen-select" name="country" id="country" required data-parsley-required-message="Please Select Country" onchange="countryId()">
                  ...
                  <option value="<?php echo e($country->id); ?>" <?php echo e((old('country')==$country)?'selected':''); ?>><?php echo e($country->countryName); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <select  class="form-control chosen-select" name="permanent_country" id="permanent_country" required data-parsley-required-message="Please Select Country">
                  <option value="">Select</option>
                  <?php $__currentLoopData = $listTypes['country']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($country->id); ?>"  <?php echo e((old('permanent_country')==$country)?'selected':''); ?>><?php echo e($country->countryName); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
              <div class="form-group">
    ...
    ********************************************************************************************-->
      <div class="panel panel-default">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <input type="hidden" name="profilepic1" value="<?php echo e($nominees->uploadPhoto); ?>"> 
                <img src="<?php echo e(URL::to('/')); ?>/storage/img/nominee/<?php echo e($nominees->uploadPhoto); ?>" style="width: 150px;height: 150px" />
            ...
            <div class="col-sm-4">
              <div class="form-group" style="float:left;">
                <input type="hidden" name="signature1" value="<?php echo e($nominees->signature); ?>"> 
                <img src="<?php echo e(URL::to('/')); ?>/storage/img/nominee/<?php echo e($nominees->signature); ?>" style="width: 150px;height: 150px" />
          ...
          <div class="col-sm-4">
            <div class="form-group">
              <input type="hidden" name="proof_file1" value="<?php echo e($proofs->file); ?>">  
              <img src="<?php echo e(URL::to('/')); ?>/storage/img/proof/<?php echo e($proofs->file); ?>" style="width: 150px;height: 150px" />
         ...
         <div class="col-sm-12"><br></div>
          ...
          <div class="row">
            <div class="col-sm-4">Nominee Proof Type
              <select class="form-control  chosen-select col-md-6" name="typeOfProof1" id="typeOfProof1" required data-parsley-required-message="Select Proof Type">
                <option value=" ">Select</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-4">Signature<span style="color:red;">*</span><input class="btn btn-success btn-fil removeattr" ui-jq="filestyle" ui-options="{icon: false, buttonName: 'btn m-b-xs w-xs btn-dark btn-rounded'}" type="file" name="nsignature1" id="nsignature1" required data-parsley-required-message="Select Signature Fle" onchange="imageCheck(this)">
                  ...
                  <?php if($errors->has('nsignature1')): ?>
                            <span class="help-inline "><?php echo e($errors->first('nsignature1')); ?></span>
                          <?php endif; ?>
              </div>
    ...
    ********************************************************************************************-->
      <div class="panel panel-default">
        <div class="panel-heading font-bold">SECOND NOMINEE DETAILS <input style="padding: 1px 10px !important" id="secondNomineeButton" type="button" class="btn btn-sm btn-info" value="Add +" onclick="secondNomineePanel(this.value)"></div>
        <div class="panel-body"  id="secondNomineePanel">
          <div class="row">
            <div class="col-sm-4">Nominee Name<span style="color:red;">*</span>
         ...
         <div class="col-sm-12"><br></div>
          ...
          <div class="row">
            <div class="col-sm-4">Nominee Proof Type
              <select class="form-control col-md-6 chosen-select" name="typeOfProof2" id="typeOfProof2" required data-parsley-required-message="Select Proof Type" >
                <option value=" ">Select</option>
                <option value="aadhar">Aadhar</option>
                <option value="license">License</option>
                <option value="pancard">Pancard</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-4">Signature<span style="color:red;">*</span><input class="btn btn-success btn-fil removeattr" ui-jq="filestyle" ui-options="{icon: false, buttonName: 'btn m-b-xs w-xs btn-dark btn-rounded'}" type="file" name="nsignature2" id="nsignature2" required data-parsley-required-message="Select Signature Fle" onchange="imageCheck(this)">
                  ...
                  <?php if($errors->has('nsignature2')): ?>
                            <span class="help-inline "><?php echo e($errors->first('nsignature2')); ?></span>
                          <?php endif; ?>
              </div>
...
<script type="text/javascript">
  $('#dateofbirth').datepicker({format:'dd-mm-yyyy', orientation:'bottom right',autoclose:true});
  $('#dob1').datepicker({format:'dd-mm-yyyy',autoclose:true});
  $('#dob2').datepicker({ format:'dd-mm-yyyy',autoclose:true});
...
<script type="text/javascript">
  ...
  $('#correspondance_country').val($('#permanent_country').val()).trigger('chosen:updated');
...
function secondNomineePanel(value)
{
  if(value=='Add +')
  {
  $("#secondNomineePanel").show();  
  $("#secondNomineePanel *").find("select, input ,textarea").attr('required',true);
  $("#secondNomineeButton").val('Add -');
  }
  else
   {
  $("#secondNomineePanel *").find("select, input ,textarea").attr('required',false);
  $("#secondNomineePanel").hide(); 
  $("#secondNomineeButton").val('Add +');
   } 
}
