          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <select name="module_id" class="form-control" id="module_id">
                ...
                <option value="1" <?php if($editpages->main_id == 1): ?> <?php echo e('selected'); ?> <?php endif; ?>>ERP</option>
                <option value="2" <?php if($editpages->main_id == 2): ?> <?php echo e('selected'); ?> <?php endif; ?>>HR</option>
              </select>
...
function order1(orderNo)
{
  ...
  <script>
    $("#module_id").change(function () {
        ...
        $.ajax({
            type: "get",
            url: "<?php echo e(URL::to('/')); ?>/admin/useraccess/fetchParent",
            data:{value:value},
            success: function(data)
            {
                $("#parent_id").html(data);
