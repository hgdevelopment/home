...
<head>
  ...
  <link rel="stylesheet" media='screen and (min-width: 0px) and (max-width: 600px)' href="<?php echo e(URL::asset('css/mobileapp.css')); ?>" type="text/css" />
  <link rel="stylesheet" media='screen and (min-width: 600px)' href="<?php echo e(URL::asset('css/app.css')); ?>" type="text/css" />

  <link rel="stylesheet" href="<?php echo e(URL::asset('css/iziToast.min.css')); ?>" type="text/css" />
...
<script src="<?php echo e(URL::asset('js/defaults-en_US.min.js')); ?>"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/js/i18n/defaults-*.min.js"></script>
  ...
  <script src="<?php echo e(URL::asset('js/notify.js')); ?>"></script>
...
<script src="<?php echo e(URL::asset('js/iziToast.min.js')); ?>"></script>
