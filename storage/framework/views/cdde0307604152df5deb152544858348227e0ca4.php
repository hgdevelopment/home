...
<form role="form" method="post" action="<?php echo e(URL::to('/')); ?>/hr/salaryMaster" id="form" data-parsley-validate onsubmit="return submitvalidate()">
			...
			<input type="hidden" name="working_days" id="working_days" value="<?php echo e($emp_working_days); ?>">
			<input type="hidden" name="per_day_salary" id="per_day_salary" value="<?php echo e(floor($perDaySalary)); ?>">
			<input type="hidden" name="per_min_salary" id="per_min_salary" value="<?php echo e(floor($perMinuteSalary)); ?>">

			<input type="hidden" name="working_weekoff" id="working_weekoff" value="<?php echo e($emp_working_weekoff); ?>">
			<input type="hidden" name="working_holidays" id="working_holidays" value="<?php echo e($emp_working_holidays); ?>">

			<input type="hidden" name="one_mine_late" id="one_mine_late" value="<?php echo e($oneMinuteLate); ?>">
			<input type="hidden" name="more_one_min" id="more_one_min" value="<?php echo e($moreOneMinute); ?>">

			<input type="hidden" name="total_leave" id="total_leave" value="<?php echo e($leave); ?>">
			<input type="hidden" name="full_day_leave" id="full_day_leave" value="<?php echo e($fullDayLeave); ?>">
			<input type="hidden" name="half_day_leave" id="half_day_leave" value="<?php echo e($halfDayLeave); ?>">
			<input type="hidden" name="approve_leave" id="approve_leave" value="<?php echo e($approveLeave); ?>">

			<input type="hidden" name="available_leave" id="available_leave" value="<?php echo e($TotalAvailLeave); ?>">
			...
			<div class="panel">
				<div class="panel-body sal">
					<div class="row">
							...
							<div class="col-md-4 col-xs-4  font-bold">
							Paid Days : <?php echo e($emp_working_days); ?>
					...
					<div class="row"><a class="text-primary see-more" onclick="showDetails('hideDetails')">See more...</a>
						<div class="col-md-12" id="details" class="row">			<input type="hidden" id="hideDetails" value="0">
							...
							<div class="col-md-3 col-xs-3 divTableCell  font-bold">
							Day Salary   <b class="data-lab text-danger"><?php echo e($perDaySalary); ?></b>
							</div>

							<div class="col-md-3 col-xs-3 divTableCell  font-bold">
							per Hour Salary   <b class="data-lab text-danger"><?php echo e($perHourSalary); ?></b>
							</div>

							<div class="col-md-3 col-xs-3 divTableCell  font-bold">
							per Minute Salary   <b class="data-lab text-danger"><?php echo e($perMinuteSalary); ?></b>
							</div>

							<div class="col-md-3 col-xs-3 divTableCell font-bold">
							Full worked Days   <b class="data-lab text-danger"><?php echo e($emp_working_full_days); ?></b>
							</div>
							...
							<div class="col-md-3 col-xs-3 divTableCell font-bold">
							Half Day     <b class="data-lab text-danger"><?php echo e($halfDayLeave); ?><?php echo e('(day) * 0.5 = '); ?><?php echo e($halfDayLeave*0.5); ?></b>
							</div>
