...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-normal h3">TCN <?php echo e($withDraws->type); ?> View</h1>
</div>
...
<div class="wrapper-md" ng-controller="FormDemoCtrl">
	<div class="panel panel-warning">
		...
		<div class="col-sm-4 font-bold text-success h4">WITHDARW STATUS : <span class="text-danger"><?php echo e($withDraws->status); ?></span></div>&nbsp;
		</div>
	</div>
	...
	<div class="panel panel-warning">
		...
		<div class="panel-body">
			<div class="col-sm-12">
		     ...
		     <div class="col-md-6 col-xs-12 divTableCell">Bank Name<b class="data-lab"><?php echo e($withDraws->bank); ?></b></div> 
		     <div class="col-md-6 col-xs-12 divTableCell"><b class="data-lab">&nbsp;</b></div> 
