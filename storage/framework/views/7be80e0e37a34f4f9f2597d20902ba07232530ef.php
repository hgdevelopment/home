...
<head>
<meta charset="utf-8">
<title>Application Form - <?php echo e($memberregistration->code); ?></title>
...
<body>
  <header id="header" class="">
    <img src="<?php echo e(URL::to('/')); ?>/img/tcnmaster/header.png" alt="">
  </header>
  <div style="border: 1px solid #FFF58F;margin-top:5px">
    <div class="section" style="float:right; margin:5px 10px 0 0">
      <table style="border:1px solid">
        <tbody>
          <tr>
            <td><img class="profile-img" src="<?php echo e(URL::to('/')); ?>/storage/img/member_img/<?php echo e($memberregistration->photo); ?>" alt="" width="120" height="150"></td>
          </tr>
        </tbody>
      </table>
    </div>
    <div class="section" style="float:left; margin:100px 0 0 10px">
      <table>
        <tbody>
          <tr>
            <th>APPLICATION NUMBER</th><th>: <?php echo e(ucfirst($memberregistration->code)); ?> </th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <th>NAME</th><th>: <?php echo e(ucfirst($memberregistration->name)); ?> </th>
          </tr>
        </tbody>
      </table>
    </div>
      ...
      <table class="table-data personal-details">
        <tbody>
          <tr>
            ...
            <th width="20%" >: <?php echo e($memberregistration->dob); ?></th>
            <td width="30%" >GENDER</td>
            <th width="40%" >: <?php echo e(ucfirst($memberregistration->gender)); ?></th>
          </tr>
          <tr><td></td><td></td></tr>
          <tr>
            <td>CASTE</td>
            <th>: <?php echo e(ucfirst($memberregistration->caste)); ?></th>
            <td>NATIONALITY</td>
            <th>: <?php echo e(ucfirst($memberregistration->country->countryName)); ?></th>
          </tr>
          <tr><td></td><td></td></tr>
          <tr>
            <td>RELIGION</td>
            <th>: <?php echo e(ucfirst($memberregistration->religion)); ?></th>
            <td>EDUCATION</td>
            <th>: <?php echo e($memberregistration->education); ?></th>
          </tr>
          <tr><td></td><td></td></tr>
          <tr>
            <td>OCCUPATION</td>
            <th>: <?php echo e($memberregistration->occupation); ?></th>
            <td>MARITAL STATUS</td>
            <th>: <?php echo e($memberregistration->maritalStatus); ?></th>
          </tr>
          <tr><td></td><td></td></tr>
          <tr>
            <td>MOBILE</td>
            <th>: <?php echo e($memberregistration->mobileId); ?> <?php echo e($memberregistration->mobileNo); ?></th>
            <td>EMAIL</td>
            <th>: <?php echo e($memberregistration->email); ?></th>
          </tr>
          <tr><td></td><td></td></tr>
          <tr>
            <td>FATHER'S / HUSBAND'S NAME</td>
            <th>: <?php echo e($memberregistration->guardian); ?></th>
            <td>HOW DO YOU KNOW ABOUT HEERA</td>
            <th>: <?php echo e($memberregistration->aboutHeera); ?></th>
          </tr>
        </tbody>
      </table>
    </div> 

    <?php $__currentLoopData = $memberregistration->address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="section">
      <div class="header-bar">
          <?php if($element->typeOfAddress == "correspondance"): ?>
            <h3 class="heading-1">Correspondence Address</h3>
          <?php else: ?>
             <h3 class="heading-1"><?php echo e(ucfirst($element->typeOfAddress)); ?> Address</h3>
          <?php endif; ?>
      </div>
      <table class="table-data personal-details">
        <tr>
          <td width="25%">ADDRESS</td>
          <th width="25%">: <?php echo e($element->address); ?></th>
          <td width="25%">CITY</td>
          <th width="25%">: <?php echo e($element->city); ?></th>
        </tr>
        <tr>
          <td>STATE</td>
 ...
 <div class="page-break"></div>
      ...
      <div class="header-bar">
        ...
        <tbody>
          ...
          <tr>
            ...
            <th>:<?php echo e(json_decode($memberregistration->membership_details)->inr->type); ?></th>
            <td>AMOUNT APPLYING FOR </td>
            <th width="25%">:<?php echo e(json_decode($memberregistration->membership_details)->inr->amount); ?></th>
          </tr>
          <tr>
            <td>AED:AMOUNT HOLDING </td>
            <th>:<?php echo e(json_decode($memberregistration->membership_details)->aed->type); ?></th>
            <td>AMOUNT APPLYING FOR</td>
            <th>: <?php echo e(json_decode($memberregistration->membership_details)->aed->amount); ?></th>
          </tr>
          <tr>
            <td>USD:AMOUNT HOLDING </td>
            <th>:<?php echo e(json_decode($memberregistration->membership_details)->usd->type); ?></th>
            <td>AMOUNT APPLYING FOR</td>
            <th>:<?php echo e(json_decode($memberregistration->membership_details)->usd->amount); ?></th>
          </tr>
          <tr>
            <td>SAR:AMOUNT HOLDING </td>
            <th>:<?php echo e(json_decode($memberregistration->membership_details)->sar->type); ?></th>
            <td>AMOUNT APPLYING FOR</td>
            <th>:<?php echo e(json_decode($memberregistration->membership_details)->sar->amount); ?></th>
          </tr>
          <tr>
            <td>CAD : AMOUNT HOLDING</td>
            <th>:<?php echo e(json_decode($memberregistration->membership_details)->cad->type); ?></th>
            <td>AMOUNT APPLYING FOR</td>
            <th>:<?php echo e(json_decode($memberregistration->membership_details)->cad->amount); ?></th>
          </tr>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tr>
          <th><u><?php echo e(ucfirst($memberregistration->proof->typeOfProof)); ?> Details</u><br><br>
              <img class="profile-img" src="<?php echo e(URL::to('/')); ?>/storage/img/proof/<?php echo e($memberregistration->proof->file); ?>" alt="" width="120" height="150"><br><br>
              Proof Number : <?php echo e($memberregistration->proof->proofNumber); ?>
    ...
    <div class="section">
      <table class="table-data personal-details">
        <tr>
          <td style="font-size:1.1em; width:50%;">Name: <b><?php echo e(ucfirst($memberregistration->name)); ?></b></td>
          <td style="font-size:1.1em; width:50%;  text-align: right;">Signature<br>
          <img src="<?php echo e(URL::to('/')); ?>/storage/img/member_img/<?php echo e($memberregistration->singnature); ?>" width="130" height="60" alt="" /></td>
        </tr>
      </table>
    </div>
