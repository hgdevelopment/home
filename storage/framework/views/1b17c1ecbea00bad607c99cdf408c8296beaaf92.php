...
<div class="wrapper-md">
  <div class="row">
    <div class="col-sm-12">
      <div class="blog-post">
        <form role="form" method="POST" action="<?php echo e(URL::to('/')); ?>/admin/Requestmember/<?php echo $__env->yieldContent('edit_id'); ?>" data-parsley-validate enctype="multipart/form-data">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type='text' name="dateofbirth" id="dateofbirth" readonly required placeholder="MM/DD/YYYY" data-language="en" class="form-control" value="<?php echo $__env->yieldContent('dateofbirth'); ?>" onchange="getAge()" />
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" name="childrens" id="childrens" data-parsley-type="integer" data-parsley-trigger="keyup" value="<?php echo $__env->yieldContent('childrens'); ?>" class="form-control">
                </div>
                <div class="col-sm-12"></div>
                <div class="form-group col-sm-4">
                  <label>Mobile No<span style="color:red;">*</span></label>
                  <div class="input-group m-b">
                    <span class="input-group-addon conId"> <?php echo $__env->yieldContent('conId12'); ?></span>
                    <input type="hidden" id="conId1" name="conId1" value="<?php echo $__env->yieldContent('conId12'); ?>">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" placeholder="How Do You Know About Heera Group" name="aboutheera" id="aboutheera" required ><?php echo $__env->yieldContent('aboutheera'); ?></textarea>
                  </div>
                </div>
                <div class="form-group col-sm-4" >
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="type_amount_inr" id="type_amount_inr" data-parsley-type="number" placeholder="INR" value="<?php echo $__env->yieldContent('type_amount_inr'); ?>" class="form-control" >
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" name="type_amount_aed" id="type_amount_aed" placeholder="AED" data-parsley-type="number" value="<?php echo $__env->yieldContent('type_amount_aed'); ?>" class="form-control" >
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" name="type_amount_usd" id="type_amount_usd" data-parsley-type="number" placeholder="USD" value="<?php echo $__env->yieldContent('type_amount_usd'); ?>" class="form-control" >
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" name="type_amount_sar" id="type_amount_sar" data-parsley-type="number" placeholder="SAR" value="<?php echo $__env->yieldContent('type_amount_sar'); ?>" class="form-control" >
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                          <label>AMOUNT OF HOLDING(IF ANY)</label>
                          <input type="text" name="type_amount_cad" data-parsley-type="number" id="type_amount_cad" placeholder="CAD" value="<?php echo $__env->yieldContent('type_amount_cad'); ?>" class="form-control" >
