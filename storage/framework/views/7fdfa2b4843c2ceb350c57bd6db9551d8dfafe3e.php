	...
	<div class="wrapper-md">
		...
		<div class="panel panel-default">
			<div class="table-responsive" style="overflow-x: initial;">
				...
				<table class="table table-striped b-t" id="view">
					<thead>
				...
				<div class="panel panel-default">
			<div class="table-responsive" style="overflow-x: initial;">
				<table class="table table-striped b-t" id="viewReq">
					<thead>
						<div class="panel-heading">
							Active TCN
						</div>
				...
				<div class="panel panel-default">
			<div class="table-responsive" style="overflow-x: initial;">
				<table class="table table-striped b-t" id="views">
					<thead>
						<div class="panel-heading">
					...
					<tbody>
						<?php $__currentLoopData = $tcnwithdrawal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tcnwithdraw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								...
								<td> 
								<a href=""  class="active"><i style="color: #018001;" class="fa fa-eye" aria-hidden="true"></i></a>
								</td>
							</tr>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</tbody>
