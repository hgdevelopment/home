    ...
    <div class="row m-t">
      ...
      <?php echo e(csrf_field()); ?>
        ...
        <div class="col-sm-12">
          ...
          <img src="<?php echo e(URL::asset('storage/img/proof/'.$approveproof->file)); ?>" draggable="true"  class="img-thumbnail " alt="" style="width: 100px;height:130px;" /><span style="margin-left: 30px;">PROOF</span><br> <span class="h6-text text-black" style="text-transform: uppercase;">Proof Type : &nbsp;<?php echo e($approveproof->typeOfProof); ?></span><br> <span class="h6-text text-black" style="text-transform: uppercase;">ID Number : &nbsp;<?php echo e($approveproof->proofNumber); ?></span></a>
  ...
  <div class="row" style="padding-bottom: 20PX;">
    ...
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body"> 
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">INR</b> : <br>&nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($approvemember->membership_details)->inr->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($approvemember->membership_details)->inr->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">AED</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($approvemember->membership_details)->aed->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($approvemember->membership_details)->aed->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">USD</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($approvemember->membership_details)->usd->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($approvemember->membership_details)->usd->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">SAR</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($approvemember->membership_details)->sar->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($approvemember->membership_details)->sar->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">CAD</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($approvemember->membership_details)->cad->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($approvemember->membership_details)->cad->amount); ?> </div>
        </div>
      </div>
    </div>
  </div>
