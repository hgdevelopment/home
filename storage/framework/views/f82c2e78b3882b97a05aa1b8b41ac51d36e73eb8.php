...
<div class="row">
                           ...
                           <div class="form-group">
                              ...
                              <select  class="form-control" id="type_of_proof" name="type_of_proof" <?php echo e(isset($proof->proof->typeOfProof)?'readonly':''); ?> data-parsley-required-message="Type of proof is required" data-parsley-trigger="blur" required>
                           ...
                           <div class="col-sm-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" placeholder="ID Number" id="proof_number" name="proof_number" value="<?php echo e(isset($proof->proof->proofNumber)?$proof->proof->proofNumber:''); ?><?php echo e(old('proof_number')); ?>" <?php echo e(isset($proof->proof->proofNumber)?'readonly':''); ?> data-parsley-required-message="ID Number is required" data-parsley-trigger="blur" >
