...
<?php $__env->startSection('body'); ?>
  <div class="bg-light lter b-b wrapper-md">
    <h1 class="m-n font-thin h3">View Withdrawn DSA </h1>
    <h6 class="m-n font-thin h5">List Withdrawn DSA.</h6>
  </div>
        ...
        <table class="table table-striped b-t" id="dsaRequest">
          ...
          <?php $__currentLoopData = $dsa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dsas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
             ...
             <td><?php echo e($dsas->email); ?></td>
             <td><a href="<?php echo e(URL::to('/')); ?>/admin/dsaWithdraw/<?php echo e($dsas->userId); ?>/viewWithdrawn"  class="active"><i  style="color: #018001;" class="fa fa-search text-success text-active" aria-hidden="true"></i></a></td>
            </tr>
