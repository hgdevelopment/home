          ...
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label></label>
                <input type="text" class="form-control" name="type_amount_aed" id="type_amount_aed" placeholder="AED" value="<?php echo $__env->yieldContent('type_amount_aed'); ?>">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label></label>
                <input type="text" class="form-control" name="type_amount_usd"  id="type_amount_usd" placeholder="USD" value="<?php echo $__env->yieldContent('type_amount_usd'); ?>">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label></label>
                <input type="text" class="form-control" name="type_amount_sar" id="type_amount_sar" placeholder="SAR" value="<?php echo $__env->yieldContent('type_amount_sar'); ?>">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label></label>
                <input type="text" class="form-control" name="type_amount_cad"  id="type_amount_cad" placeholder="CAD" value="<?php echo $__env->yieldContent('type_amount_cad'); ?>">
