...
<div class="wrapper-md" ng-controller="FormDemoCtrl">
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="col-sm-12">
				...
				<div class="col-sm-2 text-left font-bold"> <?php echo e($withDraws->appliedId); ?></div>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="col-sm-12">
				<div class="row">
					<div class="col-sm-3">Received Original Agreements</div>
					<div class="col-sm-3 font-bold">
						<?php echo e($withDraws->receivedOriginalAgreements); ?>

					</div>
					<div class="col-sm-3">HG Receipts</div>
					<div class="col-sm-3 font-bold">
						<?php echo e($withDraws->hgReceipts); ?>
