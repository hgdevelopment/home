...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-normal h3">TCN <?php echo e($withDraws->type); ?> Approval</h1>
</div>
...
<div class="wrapper-md" ng-controller="FormDemoCtrl">
	<form role="form" method="post" id="form"  action="<?php echo e(URL::to('/')); ?>/admin/tcnFullWithDrawal/<?php echo e($withDraws->id); ?>" data-parsley-validate >
		...
		<div class="panel panel-warning">
			...
			<div class="col-sm-4 font-bold text-success h4">TCN CODE: <span class="text-danger"><?php echo e($tcnrequests->tcnCode); ?></span></div>
			<div class="col-sm-4 font-bold text-success h4">TCN : <span class="text-danger"><?php echo e($tcnrequests->tcn->tcnType); ?></span></div>
			<div class="col-sm-4 font-bold text-success h4">WITHDRAW STATUS : <span class="text-danger"><?php echo e($withDraws->status); ?></span></div>&nbsp;
			</div>
		</div>
...
<div class="col-lg-7">
		...
		<div class="panel-body">
		  ...
		  <div class="col-md-6 col-xs-12 divTableCell">Withdrawal Amount<b class="data-lab"><?php echo e($withDraws->amount); ?></b></div> 
		</div>
		<br>
		<div class="panel-body">
		<div class="row">
	...
	<div class="row">
		...
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-3 font-bold">Form Received By<span class="text-danger">*</span></div>
						<div class="col-sm-3">
						...
						<div class="col-sm-3">
							...
							<input type="text" name="currencyType" id="currencyType" value="<?php echo e($tcnrequests->currencyType); ?>" class="form-control" readonly />
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-3 font-bold">Approved By<span class="text-danger">*</span></div>
						<div class="col-sm-3">
						...
						<div class="col-sm-3 font-bold">Payment Made By<span class="text-danger">*</span></div>
						<div class="col-sm-3">
				...
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-3">
	                      <input type="text" class="form-control"  id="wdappliedDate" name="wdappliedDate" value="<?php echo e(date('d-m-Y',strtotime($withDraws->appliedDate))); ?>" required data-parsley-required-message="Please Enter Withdrawal applied date" readonly>					
						</div>
						<div class="col-sm-3 font-bold">Withdrawal paid date<span class="text-danger">*</span></div>
						<div class="col-sm-3">
				...
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-3">
							<input type="text" name="debitAccountNo" id="debitAccountNo" value="<?php echo e($tcnrequests->heeraaccount->accountNumber); ?>" class="form-control" required data-parsley-required-message="Please Enter Debit acc No.(Heera's)" onblur="heeraAccountCheck(this.value)" readonly />
						</div>
						<div class="col-sm-3 font-bold">Bank</div>
						<div class="col-sm-3">
							<input type="text" name="bank" id="bank" value="<?php echo e($tcnrequests->heeraaccount->bankName); ?>" class="form-control" readonly />
						</div>
					</div>
				</div><div class="col-sm-12">&nbsp;</div>
				...
				<div class="col-sm-12">
					...
					<div class="row"><br>
							...
							<textarea  class="form-control" id="remarks" name="remarks" required data-parsley-required-message="Please Enter Remarks" ></textarea>
							</div>
					</div>
				</div>

				<input type="hidden" name="tcnId" id="tcnId" value="<?php echo e($tcnrequests->id); ?>"> 
				<input type="hidden" name="withDrawId" id="withDrawId" value="<?php echo e($withDraws->id); ?>"> 
