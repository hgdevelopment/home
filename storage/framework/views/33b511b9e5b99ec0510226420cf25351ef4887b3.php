				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="dob" id="dob" placeholder="Date of Birth"  data-language="en"  onchange="check()" value="<?php echo $__env->yieldContent('dob'); ?>" readonly="">
					...
					<div class="col-sm-4">
						<div class="form-group">
			              ...
			              <input type="hidden" id="conId" name="conId" value="<?php echo $__env->yieldContent('mobileId'); ?>">
							<input type="text" class="form-control" placeholder="Mobile No" required data-parsley-required-message="Please Enter Mobile Number" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="16" name="mobileNo" id="mobileNo" value="<?php echo $__env->yieldContent('mobileNo'); ?>" data-parsley-type="integer">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Telephone No"  name="telePhoneNo" id="telePhoneNo" data-parsley-type="integer" value="<?php echo $__env->yieldContent('telePhoneNo'); ?>" data-parsley-trigger="keyup" data-parsley-minlength="1">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<textarea type="text" class="form-control" placeholder="Address" required data-parsley-required-message="Please Enter Address " data-parsley-trigger="keyup" data-parsley-minlength="1" name="permanentAddress" id="permanentAddress"><?php echo $__env->yieldContent('permanentAddress'); ?></textarea>
	...
	<div class="col-sm-4">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<textarea type="text" class="form-control" placeholder="Address" required data-parsley-required-message="Please Enter Address " data-parsley-trigger="keyup" data-parsley-minlength="1" name="corrsAddress" id="corrsAddress"><?php echo $__env->yieldContent('corrsAddress'); ?></textarea>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					<label>Address</label>
					<textarea type="text" class="form-control" placeholder="Address"  data-parsley-trigger="keyup" data-parsley-minlength="1" name="officialAddress" id="officialAddress"><?php echo $__env->yieldContent('officialAddress'); ?></textarea>
				</div>
				<div class="form-group">
					<label>City</label>
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="form-group col-sm-6">
						...
						<input type="file" class="btn btn-success btn-fil" placeholder="Branch" style="width: 220px;" name="Accproof" id="Accproof" accept="image/png,image/jpeg" onchange="proofAcccheck();accSize(this)"><br>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Deposit Date" name="depositDate" required data-parsley-required-message="Please Select Date"  id="depositDate" value="<?php echo $__env->yieldContent('depositDate'); ?>"  data-language="en" data-date-end-date="0d" readonly="">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Bank" required data-parsley-required-message="Please Enter Bank Name" name="bankName" id="bankName" value="<?php echo $__env->yieldContent('bankName'); ?>" data-parsley-pattern="/^[a-zA-Z_ ]*$/" data-parsley-trigger="keyup" readonly="">
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label>Branch<span style="color:red;"> *</span></label>
							<input type="text" class="form-control" placeholder="Branch" required data-parsley-required-message="Please Enter Branch Name" name="branch" id="branch" value="<?php echo $__env->yieldContent('branch'); ?>" readonly="">
				...
				<div class="form-group col-sm-6">
					...
					<input type="file" class="btn btn-success btn-fil" style="width: 220px;" placeholder="Branch" name="Payproof" id="Payproof" accept="image/png,image/jpeg"  onchange="proofpaycheck();paySize(this)"><br>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Mobile No" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="16" name="refMobileNo" id="refMobileNo" value="<?php echo $__env->yieldContent('refMobileNo'); ?>" data-parsley-type="integer">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
