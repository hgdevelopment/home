...
<div class="wrapper bg-white b-b">
      <ul class="nav nav-pills nav-sm">
        ...
        <li class="active"><a href="<?php echo e(URL::to('/')); ?>/admin/tcnApprove/TCNPhysicalBenefitList">Add Physical Benefit</a></li>
        <?php endif; ?>
				      ...
				      <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" cellpadding="0" width="100%" id="table"  >
				        ...
				        <tbody>
				        	...
				        	<?php $__currentLoopData = $tcnrequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tcnrequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				                ...
				                <a  href="<?php echo e(URL::to('/')); ?>/admin/tcnApplicationForm/<?php echo e('view@@@'); ?><?php echo e($tcnrequest->tcnId); ?>"  class="active"><i style="color: #018001;" class="fa fa-search" aria-hidden="true"></i></a>
								...
								<a  onclick="physicalBenefit('<?php echo e($detail->tcnId); ?>')"  class="active"><i style="color: #018001;" class="glyphicon glyphicon-ok" aria-hidden="true"></i></a>
								<?php endif; ?>
