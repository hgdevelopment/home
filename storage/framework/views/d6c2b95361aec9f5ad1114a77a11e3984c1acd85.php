...
<?php $__currentLoopData = $main; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mains): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <div class="" id="Div<?php echo e($mains->id); ?>">
    ...
    <input type="checkbox" name="check<?php echo e($mains->id); ?>" id="check<?php echo e($mains->id); ?>" class=""   <?php if(isset($accessIds) && in_array($mains->id,$accessIds)): ?><?php echo e('checked'); ?><?php endif; ?> /><i class="font-bold"></i>

    <?php echo e(strtoupper($mains->menu_name)); ?> 
    ...
    <?php $__currentLoopData = $parent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="" id="Div<?php echo e($parents->id); ?>"> 
        ...
        <input type="checkbox" name="check<?php echo e($parents->id); ?>" id="check<?php echo e($parents->id); ?>" class="" onchange="setCheckBox(<?php echo e($parents->id); ?>)"  <?php if(isset($accessIds) && in_array($parents->id,$accessIds)): ?><?php echo e('checked'); ?><?php endif; ?> /><i class="font-bold"></i>

        <?php echo e(strtoupper($parents->menu_name)); ?> 
