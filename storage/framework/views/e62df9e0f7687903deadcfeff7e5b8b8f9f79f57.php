		...
		<tbody>
			...
			<div class="btn-group dropdown">
			  ...
			  <?php endif; ?>	
				...
				<?php if(Controller::UserAccessRights('TCN Application Edit')=='1' && $detail->status!='Removed' && $detail->status!='Transfered'): ?>
				<li>
				...
				<?php if(Controller::UserAccessRights('TCN Remove')=='1' && $detail->status!='Removed' && $detail->status!='Transfered'): ?>
				<li>
