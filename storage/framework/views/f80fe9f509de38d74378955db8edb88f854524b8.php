  ...
  <div class="row" style="padding-bottom: 20PX;">
    ...
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body"> 
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">INR</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($blacklistmembers->membership_details)->inr->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($blacklistmembers->membership_details)->inr->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">AED</b> : <br>&nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($blacklistmembers->membership_details)->aed->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($blacklistmembers->membership_details)->aed->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">USD</b> : <br>&nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($blacklistmembers->membership_details)->usd->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($blacklistmembers->membership_details)->usd->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">SAR</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($blacklistmembers->membership_details)->sar->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($blacklistmembers->membership_details)->sar->amount); ?> </div>
          <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">CAD</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($blacklistmembers->membership_details)->cad->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($blacklistmembers->membership_details)->cad->amount); ?> </div>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  {
  $.ajax({
  url: "<?php echo e(URL::to('admin/member/blacklistMember/delete')); ?>/"+id,
  type: "get",
  dataType: "html",
...
<script type="text/javascript">
  ...
  {
  $.ajax({
  url: "<?php echo e(URL::to('admin/member/blacklistMembersubmit')); ?>/"+userId,
  type: "get",
