...
use \App\Http\Controllers\Controller;
 ?>
	...
	<form role="form" method="post" action="<?php echo e(URL::to('/')); ?>/hr/salaryAllowance" id="form" data-parsley-validate>
					...
					<?php $__currentLoopData = $salary_temp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary_temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<?php if($request->type=='edit' && $request->id==$salary_temp->id): ?>
							...
							<tr>
								...
								<td><input type="text" class="form-control" name="percentage" id="percentage" value="<?php echo e($salary_temp->percentage); ?>" >
						...
						<tr>
							...
							<td>
								<div class="text-right font-bold text-primary" style="width: 25px;float: left;padding-right: 2px"><?php echo e($salary_temp->percentage); ?></div>
