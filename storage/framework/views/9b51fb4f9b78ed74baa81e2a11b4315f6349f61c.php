  ...
  <div class="row" style="margin-top:15px;">
      ...
      <div class="panel-warning">
        ...
        <table class="table">
          ...
          <tbody>
             <?php $__currentLoopData = $references; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td><?php echo e($element->name); ?></td>
              <td><?php echo e($element->mobile_no); ?></td>
              <td><?php echo e($element->email_id); ?></td>
      ...
      <div class="modal-body" >
       ...
       <div class="row  references_details " >
          <div class="col-sm-3">
              ...
              <input type="text" class="form-control" id="r_name" name="r_name[]" value="<?php echo e($element->name); ?>">
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
              <label for="name">Mobile No:</label>
              <input type="text" class="form-control" id="r_mobile" name="r_mobile[]" value="<?php echo e($element->mobile_no); ?>">
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
              <label for="name">Email ID:</label>
              <input type="text" class="form-control" id="r_email" name="r_email[]" value="<?php echo e($element->email_id); ?>">
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
              <label for="name">Relationship:</label>
              <input type="text" class="form-control" id="r_relationship" name="r_relationship[]" value="<?php echo e($element->relationship); ?>">
              </div>
            </div>
            <div class="col-sm-1">
              <div class="form-group">
...
<script>
  ...
  //         alert(1);
    ...
    $('#form_reference').submit(function(e){
      e.preventDefault();
      $.post('<?php echo e(URL::to('/')); ?>/hr/employee/reference/update',$(this).serialize(),function(data){
                if(data.result){
