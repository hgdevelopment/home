...
<?php $__env->startSection('body'); ?>
		<div class="bg-light lter b-b wrapper-md">
            <h1 class="m-n font-thin h3">View Rejected Leaves</h1>
        </div>
              ...
              <div class="col-sm-12">
                <div class="blog-post">                   
                  <div class="col-sm-12">
    				...
    				<div class="panel-heading font-bold">VIEW REJECTED LEAVES</div>
							...
							<div class="row">
								...
								<table class="table" id="enquirysolveview" >
							        ...
							        <tr>
							        	...
							        	<td><a href="<?php echo e(url('/hr/leave/view_reject_leave_details',$leaves->id)); ?>" class="btn btn-info" >View</a> </td>
	         					    </tr>
