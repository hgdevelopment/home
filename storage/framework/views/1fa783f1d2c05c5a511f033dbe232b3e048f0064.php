...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3">View Rejected Leave</h1>
</div>
      ...
      <div class="blog-post">                   
        <div class="col-md-6 col-md-offset-3">
          <div class="panel panel-info">
            <div class="panel-heading font-bold" style="background-color: #008000;color: #ffffff;border: 1px solid #008000;">VIEW REJECTED LEAVES</div>
              ...
              <div class="row">
                ...
                <div class="col-sm-12"><br></div>
                  <div class="col-sm-12">
                     <button type="button" class="btn btn-success" id="approve"><a href="<?php echo e(URL::to('/')); ?>/hr/leave/approve/<?php echo e($leaves->id); ?>"  class="active"><i class="fa fa-check" aria-hidden="true"></i>approve</button></a>
                    
                    <button type="button" class="btn btn-danger" id="cancel"><a href="<?php echo e(URL::to('/')); ?>/hr/leave/cancel/<?php echo e($leaves->id); ?>"  class="active"><i class="fa fa-times" aria-hidden="true"></i>Cancel</button>
                  </div>
                </div>
              </div>
            </div>
