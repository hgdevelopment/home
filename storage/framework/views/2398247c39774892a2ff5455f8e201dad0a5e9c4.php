    ...
    <div class="col-sm-4">
      <div class="panel panel-default">
        <div class="panel-heading font-bold">ADDRESS FOR CORRESPONDENCE
          ...
          <input type="checkbox" name="sameAddress" id="sameAddress" onclick="sameaddress()"><i style="margin-top: -10px;"></i></label>
        </span></div>
        <div class="panel-body">
          <div class="form-group col-sm-12">
            <label>Address<span style="color:red;">*</span></label>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" name="type_amount_inr" id="type_amount_inr" placeholder="INR" value="<?php echo $__env->yieldContent('type_amount_inr'); ?>" class="form-control">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label>AMOUNT OF HOLDING(IF ANY)</label>
                <input type="text" name="type_amount_aed" id="type_amount_aed" placeholder="AED" value="<?php echo $__env->yieldContent('type_amount_aed'); ?>" class="form-control" >
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label>AMOUNT OF HOLDING(IF ANY)</label>
                <input type="text" name="type_amount_usd" id="type_amount_usd" placeholder="USD" value="<?php echo $__env->yieldContent('type_amount_usd'); ?>" class="form-control">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label>AMOUNT OF HOLDING(IF ANY)</label>
                <input type="text" name="type_amount_sar" id="type_amount_sar" placeholder="SAR" value="<?php echo $__env->yieldContent('type_amount_sar'); ?>" class="form-control" >
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label>AMOUNT OF HOLDING(IF ANY)</label>
                <input type="text" name="type_amount_cad" id="type_amount_cad" placeholder="CAD" value="<?php echo $__env->yieldContent('type_amount_cad'); ?>" class="form-control" >
