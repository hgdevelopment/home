			...
			<div class="panel-body h5">
				...
				<div class="col-sm-8">
					...
					<div class="row">
						...
						<div class="col-md-6"><b class=""><?php echo e(session()->get('currencyType')); ?></b></div><br>
					</div>	
					<div class="row">
						<div class="col-md-6">Amount </div>
						<div class="col-md-6"><b class=""><?php echo e(session()->get('amount')); ?></b></div><br>
					</div>	
...
<style type="text/css">
	...
	#parsley-id-23{
		...
		<input type="hidden" id="userCode" name="userCode" value="<?php echo e($userCode); ?>">
