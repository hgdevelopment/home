...
<div class="wrapper-md" id="wrapper-md" ng-controller="FormDemoCtrl">
		...
		<div class="panel panel-default">
			<div class="panel-heading font-bold">TCN REQUEST LIST<a href="<?php echo e(URL::to('/')); ?>/admin/tcnRequest" class="btn btn-info btn-sm full-right" style="float: right;">REQUEST FORM</a></div>
...
<script type="text/javascript">
  ...
  var t=$('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(URL::to('/')); ?>/admin/tcn_request_listDataTable',
  ...
  function RequestResponse(id,status)
  {
        $.ajax({
            ...
            type: "get",
            data: {process:'RequestResponse',id:id,status:status},
