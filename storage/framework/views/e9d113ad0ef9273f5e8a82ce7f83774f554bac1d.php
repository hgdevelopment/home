    ...
    <div class="col-sm-12"></div>
      ...
      <div class="col-sm-12 col-md-6 padder-ad">
        <div class="panel panel-warning" >
          ...
          <div class="panel-body"> 
            <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">INR</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($viewmember->membership_details)->inr->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($viewmember->membership_details)->inr->amount); ?> </div>
            <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">AED</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($viewmember->membership_details)->aed->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($viewmember->membership_details)->aed->amount); ?> </div>
            <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">USD</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($viewmember->membership_details)->usd->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($viewmember->membership_details)->usd->amount); ?> </div>
            <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">SAR</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($viewmember->membership_details)->sar->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($viewmember->membership_details)->sar->amount); ?> </div>
            <div class="col-md-12 col-xs-12 divTableCell"> <b class="data-lab pull-left">CAD</b> :<br> &nbsp;&nbsp;&nbsp;AMOUNT HOLDING : <?php echo e(json_decode($viewmember->membership_details)->cad->type); ?> &nbsp;&nbsp;| &nbsp;&nbsp;AMOUNT APPLYING FOR : <?php echo e(json_decode($viewmember->membership_details)->cad->amount); ?> </div>
          </div>
        </div>
      </div>
   </div>
          ...
          <div class="col-sm-6 col-sm-offset-6">
            ...
            <div class="form-group" style="display:none;" id="show">
              ...
              <select  class="form-control" required data-parsley-required-message="Please Select Reason" name="reason[]" id="reason" size="7" multiple>
                ...
                <option value="Your Date of Birth is not same as proof">Date of Birth is not same as proof</option>
                <option value="Your Photo is not clear">Photo is not clear</option>
                <option value="Your Signature is not clear">Signature is not clear</option>
              </select><br>
              <label>Reason</label>
