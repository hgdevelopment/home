					...
					<div class="col-md-12">
						<div class="row">
				            ...
				            <div class="col-md-4">
				             ...
				             <div class="col-md-4">
				              ...
				              <input type="number" name="benefitLockingDuration" class="form-control" placeholder="Enter Benefit Locking Duration"  value="<?php echo $__env->yieldContent('benefitLockingDuration'); ?><?php echo e(old('benefitLockingDuration')); ?>"  data-parsley-trigger="change" data-parsley-type="integer" required data-parsley-required-message="Please Enter Valid Benefit Locking Duration" />
				            </div>
				        ...
				        <div class="row">
				           ...
				           <div class="col-md-4">
				              ...
				              <input class="form-control"  id="openOn" name="openOn" value="<?php if(isset($Edit['openOn'])): ?><?php echo e(date('d-m-Y',strtotime($Edit['openOn']))); ?><?php endif; ?><?php echo e(old('openOn')); ?>" required="" data-parsley-required-message="Select Deposite Date" readonly="" type="text">
				            </div>

				            <div class="col-md-4">
				              <label>Close On</label>
				              <input class="form-control"  id="closeOn" name="closeOn" value="<?php if(isset($Edit['openOn'])): ?><?php echo e(date('d-m-Y',strtotime($Edit['closeOn']))); ?><?php endif; ?><?php echo e(old('closeOn')); ?>" required="" data-parsley-required-message="Select Deposite Date" readonly="" type="text">
				            </div>
				        </div>   
