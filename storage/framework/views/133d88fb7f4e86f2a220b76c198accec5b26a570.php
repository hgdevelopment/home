...
<head>
<meta charset="utf-8">
<title>Application Form - <?php echo e($dsa->name); ?></title>
...
<body>
  <header id="header" class="">
    <img src="<?php echo e(URL::to('/')); ?>/img/tcnmaster/headerDSA.png" alt="">
  </header>
  <div style="border: 1px solid #BAD2EF;margin-top:5px">
    <div class="section" style="float:right; margin:5px 10px 0 0">
      <table style="border:1px solid">
        <tbody>
          <tr>
            <td><img class="profile-img" src="<?php echo e(URL::to('/')); ?>/storage/img/dsa_img/<?php echo e($dsa->photo); ?>" alt="" width="120" height="150" ></td>
          </tr>
        </tbody>
      </table>
    </div>
    <div class="section" style="float:left; margin:100px 0 0 10px">
      <table>
        <tbody>
          <tr>
            <th>APPLICATION NUMBER</th><th>: <?php echo e($dsa->username); ?> </th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <th>NAME</th><th>: <?php echo e($dsa->name); ?> </th>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          <tr>
            <td>DATE OF BIRTH</td><th>: <?php echo e($dsa->dob); ?></th>
            <td>GENDER</td><th>: <?php echo e($dsa->gender); ?></th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <td>RELIGION</td><th>: <?php echo e($dsa->religion); ?></th>
            <td>NATIONALITY</td><th>: <?php echo e($countryname->countryNames); ?></th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <td>MOBILE</td><th>:(<?php echo e($dsa->mobileId); ?>) <?php echo e($dsa->mobileNumber); ?></th>
            <td>EMAIL</td><th>: <?php echo e($dsa->email); ?></th>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          ...
          <?php if($addresses->typeOfAddress == 'permanent'): ?>
          <tr>
            <td>ADDRESS</td><th>: <?php echo e($addresses->address); ?></th>
            <td>CITY</td><th>: <?php echo e($addresses->city); ?></th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <td>STATE</td><th>: <?php echo e($addresses->state); ?></th>
            <td>PIN CODE</td><th>: <?php echo e($addresses->pin); ?></th>
          </tr>
          <?php endif; ?>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          <?php $__currentLoopData = $address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addresses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($addresses->typeOfAddress == 'correspondance'): ?>
          <tr>
            <td>ADDRESS</td><th>: <?php echo e($addresses->address); ?></th>
            <td>CITY</td><th>: <?php echo e($addresses->city); ?></th>
          </tr>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          <?php $__currentLoopData = $address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addresses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($addresses->typeOfAddress == 'official'): ?>
          <tr>
            <td>ADDRESS</td><th>: <?php echo e($addresses->address); ?></th>
            <td>CITY</td><th>: <?php echo e($addresses->city); ?></th>
          </tr>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          <tr>
            <td>ACCOUNT NUMBER</td><th>: <?php echo e($dsabank->accountNumber); ?></th>
            <td>BANK NAME</td><th>: <?php echo e($dsabank->bankName); ?></th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <td>BRANCH</td><th>: <?php echo e($dsabank->branchName); ?></th>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          <tr>
            <td>PAY MODE</td><th>: <?php echo e($dsapaymentdetails->payment_mode); ?></th>
            <td><?php echo e($dsapaymentdetails->payment_mode); ?> NO</td><th>: <?php echo e($dsapaymentdetails->transactionNumber); ?></th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <td>HEERA'S ACCOUNT NO</td><th>: <?php echo e($dsapaymentdetails->accountNumber); ?></th>
            <td>BANK NAME</td><th>: <?php echo e($dsapaymentdetails->bank); ?></th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <td>BRANCH</td><th>: <?php echo e($dsapaymentdetails->branch); ?></th>
            <td>DEPOSIT DATE</td><th>: <?php echo e($dsapaymentdetails->paymentDate); ?></th>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          <tr>
            <td>REFEREES NAME</td><th>: <?php echo e($dsareference->name); ?></th>
            <?php $__currentLoopData = $address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addresses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($addresses->typeOfAddress=='referance'): ?>
            <td>ADDRESS</td><th>: <?php echo e($addresses->address); ?></th>
          </tr>
          <tr><td></td></tr>
          <tr>
            ...
            <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <td>MOBILE NO</td><th>: <?php echo e($dsareference->referenceMobileNumber); ?></th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <td>EMAIL</td><th>: <?php echo e($dsareference->referenceEmail); ?></th>
            <td>RELATIONSHIP</td><th>: <?php echo e($dsareference->referenceRelation); ?></th>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          <tr>
            <td><b>ID PROOF</b><br><br><img class="profile-img" src="<?php echo e(URL::asset('storage/img/proof/'.$dsaProof->file)); ?>" alt="" width="150" height="150"></td>
            <td><b>PAYMENT PROOF</b><br><br><img class="profile-img" src="<?php echo e(URL::asset('storage/img/payProof/'.$dsapaymentdetails->file)); ?>" alt="" width="150" height="150"></td>
            <td><b>ACCOUNT PROOF</b><br><br><img class="profile-img" src="<?php echo e(URL::asset('storage/img/Accproof/'.$dsabank->Accproof)); ?>" alt="" width="150" height="150"></td>
          </tr> 
        </tbody>
      </table>
    </div>
    ...
    <div class="section">
      ...
      <div class="section" style="margin:0 25px">
        ...
        <p style="text-align:right"><img class="profile-img" src="<?php echo e(URL::to('/')); ?>/storage/img/dsa_img/<?php echo e($dsa->signature); ?>" alt="" width="120" height="60"></p>
