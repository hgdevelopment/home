        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="input-group m-b"> 
                <div class="input-group-btn dropdown">
                  <select class="btn btn-default" id="incomeid" name="incomeid" required data-parsley-required-message="Please Select income type">
                  <option value="">--Select--</option>
                ...
                <input type="text" placeholder="Income" id="income" name="income" value="{{ old('income') }}" class="form-control" required  data-parsley-trigger="keyup" data-parsley-type="number" data-parsley-required-message="Please Enter Income" data-parsley-min="1">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="input-group m-b">
                ...
                <input type="text" class="phone-control" placeholder="Mobile No" id="mobileno" name="mobileno" value="{{old('mobileno')}}" required data-parsley-maxlength="16" data-parsley-maxlength-message="Please enter valid phone no" data-parsley-required-message="Please enter valid mobile number" data-parsley-type="integer" data-parsley-trigger="keyup" data-parsley-min="1" >
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <textarea type="text" class="form-control" placeholder="How Do You Know About Heera Group" required name="aboutheera" id="aboutheera" data-parsley-required-message="Please Enter Reference"></textarea>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="file" class="btn btn-success btn-fil" id="profilepic" name="profilepic" data-parsley-required-message="Please Upload Photo" accept="image/png,image/jpeg" onchange="validateFileType();photoSize(this)" required>
          ...
          <div class="col-sm-4">
            <div class="form-group" style="float:left;">
              ...
              <input type="file" class="btn btn-success btn-file" id="signature" name="signature" accept="image/png,image/jpeg" data-parsley-required-message="Please Upload Signature" onchange="validateSig();sigSize(this)" required>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="Pin" data-parsley-trigger="keyup" required data-parsley-maxlength="6" data-parsley-minlength="1" data-parsley-type="integer" data-parsley-required-message="Please Enter Valid Pin number" data-parsley-minlength-message="Please enter valid pin" id="permanent_pin" name="permanent_pin" value="{{ old('permanent_pin') }}">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
          ...
          <textarea type="text" class="form-control" required data-parsley-required-message="Please enter address" placeholder="Address" id="correspondance_addr" name="correspondance_addr">{{ old('correspondance_addr') }}</textarea>
        ...
        <div class="form-group">
          <label>City<span style="color:red;">*</span></label>
          <input type="text" class="form-control" placeholder="City" required data-parsley-required-message="Please enter city" required id="correspondance_city" name="correspondance_city" value="{{ old('correspondance_city') }}">
        ...
        <div class="form-group">
          <label>State<span style="color:red;">*</span></label>
          <input type="text" class="form-control" placeholder="State" data-parsley-required-message="Please enter state" required data-parsley-pattern="^[A-Z a-z]*$" data-parsley-trigger="keyup" id="correspondance_state" name="correspondance_state" value="{{ old('correspondance_state') }}">
        ...
        <div class="form-group">
          <label>Pin<span style="color:red;">*</span></label>
          <input type="text" id="correspondance_pin" name="correspondance_pin" class="form-control" required data-parsley-maxlength="6" data-parsley-minlength="1" data-parsley-minlength-message="Please enter valid pin" data-parsley-required-message="Please Enter valid Pin number" data-parsley-trigger="keyup" placeholder="Pin" data-parsley-type="integer"  value="{{ old('correspondance_pin') }}">
  ...
  <div class="col-sm-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <label>Pin</label>
          <input type="text" class="form-control" data-parsley-maxlength="6" data-parsley-minlength="1" data-parsley-minlength-message="Please enter valid pin" data-parsley-required-message="Please Enter valid pin" data-parsley-trigger="keyup" placeholder="Pin" id="official_pin" name="official_pin" data-parsley-type="integer" value="{{ old('official_pin') }}">
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="AMOUNT APPLYING FOR" id="amount_inr" name="amount_inr" data-parsley-type="number" value="{{ old('amount_inr') }}" >
      ...
      <div class="panel-body">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="file" class="btn btn-success btn-fil" placeholder="Proof File" id="proof_file" name="proof_file"
             accept="image/png,image/jpeg" data-parsley-required-message="Please Upload Proof" onchange="proofcheck();idSize(this)" required>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group" >
              ...
              <select  class="form-control" id="assign_member" name="assign_member" required data-parsley-required-message="please select Assign Member">
              <option value="">Select</option>
          ...
          <div class="col-sm-6" id="me">
            <div class="form-group">
              <label>&nbsp;</label>
              <select class="form-control" id="mename" name="mename" data-parsley-required-message="Please select ME" required>
              <option value="">--Select--</option>
              @foreach($me as $mes)
              ...
              @if ($errors->has('mename'))
              <span class="help-inline">{{$errors->first('mename')}}</span>
              @endif
            </div>
          </div>
        </div> 
...
$(document).ready(function()
{
  ...
  $('#assign_member').on('change', function() 
  {
    ...
    { 
      ...
      if(mename=="")
      {
        $('#meerror').html('Select this field');
        return false;
      }
      else
      {
...
<script type="text/javascript">
function photoSize(fieldObj) // for photo
{
...
function sigSize(fieldObj) // for signature
{
var FileName  = fieldObj.value;
var FileExt = FileName.substr(FileName.lastIndexOf('.')+1);
var FileSize = fieldObj.files[0].size;
...
function idSize(fieldObj) // for proof
{
var FileName  = fieldObj.value;
var FileExt = FileName.substr(FileName.lastIndexOf('.')+1);
var FileSize = fieldObj.files[0].size;
