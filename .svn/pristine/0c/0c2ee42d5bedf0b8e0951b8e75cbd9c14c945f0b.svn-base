...
<div class="row">
    ...
    <div class="row">
      <div class="col-sm-12">
      <div class="panel panel-warning">
        <div class="panel-heading">NOMINEE DETAILS(1) </div>
        ...
        <table class="table table-striped m-b-none" style="background: #f3f3f3;">
          ...
          <tr> 
              ...
              <th colspan="4">
                  <img src="<?php echo e(URL::asset('/storage/img/nominee/'.$tcnDetails->nominee_one->uploadPhoto)); ?>" class="img-thumbnail" alt="" style="width: 150px;" /> &nbsp;
                     <img src="<?php echo e(URL::asset('/storage/img/nominee/'.$tcnDetails->nominee_one->signature)); ?>" class="img-thumbnail" alt="" style="width: 120px;" />
            ...
            <tr>  
              ...
              <th>
                <?php echo e($tcnDetails->nominee_one->name); ?>

              </th>
              <td>Date of Birth</td>
              <th>
                 <?php echo e($tcnDetails->nominee_one->dob); ?>
            ...
            <td>Relation with the Applicant</td>
              <th>
                 <?php echo e($tcnDetails->nominee_one->relationWithApplicant); ?>

              </th> 
              <td>Gender</td>
              <th>
                <?php echo e($tcnDetails->nominee_one->gender); ?>
            ...
            <td>Address</td>
              <th>
                <?php echo e($tcnDetails->nominee_one->address->address); ?>

              </th> 
              <td>City</td>
              <th>
                <?php echo e($tcnDetails->nominee_one->address->city); ?>
            ...
            <td>State</td>
              <th>
                 <?php echo e($tcnDetails->nominee_one->address->state); ?>

              </th>   
            <td>Pin</td>
              <th>
                <?php echo e($tcnDetails->nominee_one->address->pin); ?>
            ...
            <td>Mobile No.</td>
              <th>
                <?php echo e($tcnDetails->nominee_one->mobile); ?>

              </th> 
            <td>Email</td>
              <th>
                <?php echo e($tcnDetails->nominee_one->email); ?>
     ...
     <div class="row">
      <div class="col-sm-12">
      <div class="panel panel-warning">
        <div class="panel-heading">NOMINEE PROOF(1) </div>
         <table class="table table-striped m-b-none" style="background: #f3f3f3;">
          <tbody>
            <tr>  
              ...
              <td>Type of proof</td>
              <th>
                <?php echo e($tcnDetails->nominee_one->proof->typeOfProof); ?>

              </th>
              <td>ID Number</td>
              <th>
                 <?php echo e($tcnDetails->nominee_one->proof->proofNumber); ?>
            ...
            <tr>   
              ...
              <td>Proof</td>
              <th>
              <img src="<?php echo e(URL::asset('/storage/img/proof/'.$tcnDetails->nominee_one->proof->file)); ?>" class="img-thumbnail" alt="" style="width: 120px;" />
              </th> 
                 <td></td>
              <th>
     ...
     <div class="row">
      <div class="col-sm-12">
      <div class="panel panel-warning">
        <div class="panel-heading">NOMINEE DETAILS(2) </div>
        ...
        <table class="table table-striped m-b-none" style="background: #f3f3f3;">
          ...
          <tr> 
              ...
              <th colspan="4"> 
                  <img src="<?php echo e(URL::asset('/storage/img/nominee/'.$tcnDetails->nominee_two->uploadPhoto)); ?>" class="img-thumbnail" alt="" style="width: 150px;" /> &nbsp;
                     <img src="<?php echo e(URL::asset('/storage/img/nominee/'.$tcnDetails->nominee_two->signature)); ?>" class="img-thumbnail" alt="" style="width: 120px;" />
            ...
            <tr>  
              ...
              <td>Name of Nominee</td>
              <th>
                <?php echo e($tcnDetails->nominee_two->name); ?>

              </th>
              <td>Date of Birth</td>
              <th>
                 <?php echo e($tcnDetails->nominee_two->dob); ?>
            ...
            <td>Relation with the Applicant</td>
              <th>
                 <?php echo e($tcnDetails->nominee_two->relationWithApplicant); ?>

              </th> 
              <td>Gender</td>
              <th>
                <?php echo e($tcnDetails->nominee_two->gender); ?>
            ...
            <td>Address</td>
              <th>
                <?php echo e($tcnDetails->nominee_two->address->address); ?>

              </th> 
              <td>City</td>
              <th>
                <?php echo e($tcnDetails->nominee_two->address->city); ?>
            ...
            <td>State</td>
              <th>
                 <?php echo e($tcnDetails->nominee_two->address->state); ?>

              </th>   
            <td>Pin</td>
              <th>
                <?php echo e($tcnDetails->nominee_two->address->pin); ?>
            ...
            <td>Mobile No.</td>
              <th>
                <?php echo e($tcnDetails->nominee_two->mobile); ?>

              </th> 
            <td>Email</td>
              <th>
                <?php echo e($tcnDetails->nominee_two->email); ?>
     ...
     <div class="row">
      <div class="col-sm-12">
      <div class="panel panel-warning">
        <div class="panel-heading">NOMINEE PROOF(2) </div>
         <table class="table table-striped m-b-none" style="background: #f3f3f3;">
          <tbody>
            <tr>  
              ...
              <td>Type of proof</td>
              <th>
                <?php echo e($tcnDetails->nominee_two->proof->typeOfProof); ?>

              </th>
              <td>ID Number</td>
              <th>
                 <?php echo e($tcnDetails->nominee_two->proof->proofNumber); ?>
            ...
            <tr>   
              ...
              <td>Proof</td>
              <th>
              <img src="<?php echo e(URL::asset('/storage/img/proof/'.$tcnDetails->nominee_two->proof->file)); ?>" class="img-thumbnail" alt="" style="width: 120px;" />
              </th> 
                 <td></td>
              <th>
