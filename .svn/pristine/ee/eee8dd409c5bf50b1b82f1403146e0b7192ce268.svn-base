        ...
        <div class="col-md-6 col-md-offset-3">
          <div class="panel panel-info">
            <div class="panel-heading font-bold">VIEW APPROVED LEAVES</div>
             <div class="panel-heading font-bold"><label>Employee Code</label>:<label><b>{{ $leaves->user_id}}</b></label><br><label>Employee Name</label>:<label><b>{{ $leaves->name}}</b></label></div>
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class=" col-sm-12 divTableCell" ><strong >Code</strong><b class="data-lab  lab-2" ><span style="padding-right: 30px;">:</span>{{ $leaves->user_id}}</b></div>
                  <div class=" col-sm-12 divTableCell"><strong >Name</strong><b class="data-lab lab-2" ><span style="padding-right: 30px;">:</span>{{ $leaves->name}}</b></div>
              ...
              <div class="row">
                ...
                <div class="col-sm-12"><br></div>
                  <div class="col-sm-12">
                    ...
                    <button type="button" class="btn btn-danger" id="reject"><a href="{{ URL::to('/') }}/hr/leave/reject/{{ $leaves->id}}"  class="active"><i class="fa fa-times" aria-hidden="true"></i>&nbsp;Reject</button>
                    <button type="button" class="btn btn-info " id="cancel"><a href="{{ URL::to('/') }}/hr/leave/cancel/{{ $leaves->id}}"  class="active"<i class="fa fa-ban" aria-hidden="true"></i>&nbsp;Cancel</button>
                  </div>
                </div>
              </div>
            </div>
