              ...
              <div class="row">
                ...
                <div class="col-sm-12"><br></div>
                  <div class="col-sm-12">
                    ...
                    <button type="button" class="btn btn-danger" id="cancel"><a href="{{ URL::to('/') }}/hr/leave/cancel/{{ $leaves->id}}"  class="active"><i class="fa fa-times" aria-hidden="true"></i>Cancel</button>
                  </div>
                </div>
              </div>
            </div>
