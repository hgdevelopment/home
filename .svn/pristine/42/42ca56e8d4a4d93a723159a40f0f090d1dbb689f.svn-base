@extends('admin.layout.erp1')
  ...
  <div class="wrapper-md">
      ...
      <div class="col-sm-12">
        ...
        <div class="blog-post">
         <form role="form" method="POST" action="{{URL::to('/') }}/admin/member/@yield('edit_id')" data-parsley-validate enctype="multipart/form-data">
         {{csrf_field()}}                   
          <div class="col-sm-12">
           ...
           @show
            <div class="panel panel-default">
              ...
              <div class="panel-body">
               <div class="row">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" readonly id="religion" name="religion" value="Islam"@yield('religion')=='Islam') {{ 'selected' }}>
                </div>
                <div class="form-group col-sm-4">
                  <label>Caste</label>
             ...
             <div class="input-group m-b"> 
              ...
              <input type="text" name="income" id="income" value="@yield('income')" required data-parsley-required-message="Please Enter Income" class="form-control" data-parsley-type="number" data-parsley-trigger="keyup" data-parsley-min="1">
            </div>
            </div>
            </div>
            <div class="form-group col-sm-4">
             ...
             <div class="form-group col-sm-4" >
              ...
              <input type="text" name="childrens" id="childrens" data-parsley-type="number" data-parsley-trigger="keyup" value="@yield('childrens')" class="form-control" >
            </div>
            ...
            <div class="form-group col-sm-4">
              ...
              <div class="input-group m-b">
                ...
                <input type="hidden" id="conId1" name="conId1" class="conId1" value="@yield('conId1')">
              ...
              <input type="text" class="form-control" placeholder="Landline No" data-parsley-type="integer" data-parsley-maxlength="16" data-parsley-trigger="keyup" id="landlineno" name="landlineno" value="@yield('landlineno')" >
      ...
      <div class="form-group col-sm-4" >
        ...
        <input type="hidden" name="MAX_FILE_SIZE" value="1048576" />
          @if(isset($viewmember->id))
            ...
            <img src="{{ URL::asset('storage/img/member_img/'.$viewmember->photo)}}" style="width:100px;height:100px;margin-top: 10px;">
            <input type="hidden" name="photo_update" value="{{$viewmember->photo}}">
          @endif
      </div>
      <div class="form-group col-sm-4">
        ...
        @if(isset($viewmember->id))
          ...
          <img src="{{ URL::asset('storage/img/member_img/'.$viewmember->singnature)}}" style="width:100px;height:100px; margin-top: 10px;">
          <input type="hidden" name="sign_update" value="{{$viewmember->singnature}}">
        @endif
      </div>
    </div>
  </div>
      ...
      <div class="panel panel-default">
        ...
        <select  class="form-control" id="corr_country" name="corr_country" required data-parsley-required-message="Please Select Country">
         <option value="">Select</option>
          ...
          <div class="form-group col-sm-12">
            <label>Pin<span style="color:red;">*</span></label>
            <input type="text" name="corr_pin" id="corr_pin" required data-parsley-type="integer" value="@yield('corr_pin')"  data-parsley-required-message="Please Enter Pin Number" data-parsley-trigger="keyup" data-parsley-minlength="4" data-parsley-maxlength="6" class="form-control" >
          </div>
       </div>
       </div>
      </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading font-bold"> Official Address</div>
            <div class="panel-body">
              <div class="form-group col-sm-12">
                <label>Address</label>
                <textarea type="text" name="official_addr" id="official_addr" class="form-control" style="height:5%">@yield('official_addr')</textarea>
              </div>
              <div class="form-group col-sm-12">
                <label>City</label>
              ...
              <div class="form-group col-sm-12">
                <label>State</label>
                <input type="text" name="official_state" id="official_state" data-parsley-pattern="^[A-Z a-z]*$" data-parsley-trigger="keyup" value="@yield('official_state')" class="form-control" >
              </div>
              <div class="form-group col-sm-12">
            <label>Country</label>
          ...
          <div class="form-group col-sm-12">
            <label>Pin</label>
            <input type="text" name="official_pin" id="official_pin" data-parsley-minlength="4" data-parsley-type="integer" data-parsley-trigger="keyup" data-parsley-maxlength="6" value="@yield('official_pin')" class="form-control" >
          </div>
        </div>
        </div>
    </div>
      ...
      <div class="col-sm-6">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
              <div class="col-sm-6">
                <div class="form-group">
                <label style="font-size: 12px;">AMOUNT OF HOLDING(IF ANY)</label>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label style="font-size: 12px;">AMOUNT APPLYING FOR </label>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label></label>
                <input type="text" class="form-control" name="type_amount_aed" id="type_amount_aed" placeholder="AED" value="@yield('type_amount_aed')">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label></label>
                <input type="text" class="form-control" name="type_amount_usd" id="type_amount_usd" placeholder="USD" value="@yield('type_amount_usd')">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label></label>
                <input type="text" class="form-control" name="type_amount_sar" id="type_amount_sar" placeholder="SAR" value="@yield('type_amount_sar')">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label></label>
                <input type="text" class="form-control" name="type_amount_cad" id="type_amount_cad" placeholder="CAD" value="@yield('type_amount_cad')">
          ...
          <div class="panel-body">
            ...
            <div class="form-group col-sm-6">
              ...
              @if(isset($viewmem->id))
                ...
                <img src="{{ URL::asset('storage/img/proof/'.$viewmem->file)}}" style="width:100px; margin-top: 10px;">
                <input type="hidden" name="proof_update" value="{{$viewmem->file}}">
              @endif
            </div>
          </div>
       </div>
...
@endsection fieldObj.files[0].size;
        $("#photoSize").html("");
        if(FileSize>102400)
    {
      $("#photoSize").html("Upload File size allowed is 100 Kb.");
