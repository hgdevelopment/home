    ...
    <div class="row">
      ...
      <div class="form-group col-sm-4" >
        ...
        <input type="hidden" name="MAX_FILE_SIZE" value="1048576" />
          <?php if(isset($viewmember->id)): ?>
            ...
            <img src="<?php echo e(URL::asset('storage/img/member_img/'.$viewmember->photo)); ?>" style="width:100px;height:100px;">
      ...
      <div class="form-group col-sm-4">
        ...
        <?php if(isset($viewmember->id)): ?>
          ...
          <img src="<?php echo e(URL::asset('storage/img/member_img/'.$viewmember->singnature)); ?>" style="width:100px;height:100px;">
          ...
          <div class="panel-body">
            ...
            <div class="form-group col-sm-6">
              ...
              <?php if(isset($viewmem->id)): ?>
                ...
                <img src="<?php echo e(URL::asset('storage/img/proof/'.$viewmem->file)); ?>" style="width:100px;">
