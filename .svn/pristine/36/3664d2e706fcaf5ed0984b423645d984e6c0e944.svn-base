...
<div class="bg-light lter b-b wrapper-md">
	...
	<form action="{{ URL::to('/') }}/admin/reassigndsa/view" method="post"  id="form" data-parsley-validate>
	{{csrf_field()}}
							...
							<div class="panel-body">
							  ...
							  <input type="hidden" name="id" id="id"  class="form-control" value="{{$reassigns->id}}">
								<div class="col-md-4">
									...
									<label>{{$reassigns->username}}</label>
								</div>
								<div class="col-md-4">
								...
								{{-- 	<label>{{$re['username']}}</label> --}}
									<label>{{$data}}({{$addedunder}})</label>
								</div>
								...
								<div class="col-md-6" id="dsa">
									<label><strong> RE ASSIGNED TO</strong></label><br>
									<select type="text" name="assignedtodsa" id="assignedtodsa"  class="form-control" placeholder="Assigned To" required >
										<option value="">Select</option>
					                    @foreach ($dsa as $dsas)
								...
								<div class="col-md-6" id="me">
									<label><strong> RE ASSIGNED TO</strong></label><br>
									<select type="text" name="assignedtome" id="assignedtome"  class="form-control" placeholder="Assigned To" required >
										<option value="">Select</option>
					                    @foreach ($me as $mes)
								...
								<div class="col-md-6" id="oi">
									<label><strong> RE ASSIGNED TO</strong></label><br>
									<select type="text" name="assignedtooi" id="assignedtooi"  class="form-control" placeholder="Assigned To" required >
										<option value="">Select</option>
					                    @foreach ($oi as $ois)
