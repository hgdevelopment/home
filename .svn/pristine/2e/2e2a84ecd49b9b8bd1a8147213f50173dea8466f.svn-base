...
<div class="wrapper bg-white b-b">
      <ul class="nav nav-pills nav-sm">
        ...
        <li class="active"><a href="{{ URL::to('/') }}/admin/tcnApprove/TCNPhysicalBenefitList">Add Physical Benefit</a></li>
        @endif
				      ...
				      <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" cellpadding="0" width="100%" id="table"  >
				        ...
				        <tbody>
				        	...
				        	@foreach($tcnrequest as $tcnrequest)
				                ...
				                <a  href="{{ URL::to('/') }}/admin/tcnApplicationForm/{{'view@@@'}}{{$tcnrequest->tcnId}}"  class="active"><i style="color: #018001;" class="fa fa-search" aria-hidden="true"></i></a>
