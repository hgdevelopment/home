    ...
    <div class="row m-t">
      ...
      {{ csrf_field() }}
        <div class="col-sm-12">
          ...
          <img src="{{ URL::asset('storage/img/proof/'.$memberproof->file)}}" draggable="true"  class="img-thumbnail " alt="" style="width: 100px;height:130px;" /><span style="margin-left: 30px;">PROOF</span><br> <span class="h6-text text-black" style="text-transform: uppercase;">Proof Type : &nbsp;{{$memberproof->typeOfProof}}</span><br> <span class="h6-text text-black" style="text-transform: uppercase;">ID Number: &nbsp;{{$memberproof->proofNumber}}</span></a>
          ...
          <a href="#" class=" pop3 ">  <img src="{{ URL::asset('storage/img/member_img/'.$member->singnature)}}" draggable="true"  class="img-thumbnail" alt="" style="width: 100px;height:50px;" /></a>
        </div>
      </form>
    </div>
  </div>
  ...
  <div class="row" style="padding-bottom: 20PX;">
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body">
          @foreach($countryaddress as $country)
    ...
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body">
          @foreach($countryaddress as $country) @endforeach
          @foreach($memberaddress as $address)
    ...
    <div class="col-sm-12">
      ...
      <div class="col-sm-12">
        <div class="col-sm-4 col-sm-offset-8">
          <a href="{{ URL::to('/') }}/admin/member/{{ $member->userId }}/requestedit"  class="active">  
          <button name="edit" type="submit" class="btn btn-info" id="edit">Edit</button></a>
          <a href="{{URL::to('/')}}/admin/memberPdfView/{{ $member->userId }}" class="active">
