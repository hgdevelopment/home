  ...
  <br>
    ...
    <div class="section" style="text-align:center;padding-top: 10px; ">
        <table  cellspacing="0" cellpadding="0" border="0" align="center" style="font-size: 11px;">
            <tr><td align="center" ><b>{{ucfirst($resigns->branch_name)}},&nbsp;{{ucfirst($resigns->address1)}},{{ucfirst($resigns->city)}}</b></td></tr>
            <tr><td align="center">&nbsp;<b>{{ucfirst($resigns->state)}},{{ucfirst($resigns->pinNo)}}</b></td></tr>
    ...
    <div style="margin-left: 30px;padding-top: -20px;line-height: 13px;font-size: 13px;">
        <table width="100%">
            ...
            <tr><td ><b>{{ucfirst($resigns->salutation_name)}}{{ucfirst($resigns->name)}}</b></td></tr>
            <tr><td >{{ucfirst($resigns->address)}},</td></tr>
            <tr><td >{{ucfirst($resigns->city)}},</td></tr>
            <tr><td >{{ucfirst($resigns->state)}},</td></tr>
            <tr><td >{{ucfirst($resigns->countryName)}},</td></tr>
            <tr><td >{{ucfirst($resigns->zip_code)}}</td></tr>
            <tr><td >&nbsp;</td></tr>
            <tr><td></td></tr>
        ...
        <table width="730px" align="center" >
            <tr>
                ...
                <td width="590px" valign="top" style="padding:0 30px;text-align: justify; font-size: 13px;     line-height: 20px;">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>I</b> would like to inform you that I am resigning from my position as <b style="text-transform: capitalize;">{{$resigns->designation_name}}</b> for the company.
    ...
    <div style="padding:0 30px;">
       ...
       <!--  <tr><td align="left"><img src="{{URL::to('/') }}/img/tcnmaster/signature.jpg"></td></tr> -->
        <tr><td width="440px" valign="top">{{ucfirst($resigns->salutation_name)}}{{ucfirst($resigns->name)}}</td>
