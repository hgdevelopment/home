 ...
 <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              "{{isset($bank->accountHolderName)?$bank->accountHolderName:''}}{{old('benifit_account_bank_holder')}}" {{isset($bank->accountHolderName)?'readonly':''}}  data-parsley-required-message="Account Holder Name is required" required data-parsley-trigger="blur" data-parsley-pattern="/^[^-\s][a-zA-Z_ ]*$/" data-parsley-equalto="#memberName" data-parsley-equalto-message="should be same as member name">
