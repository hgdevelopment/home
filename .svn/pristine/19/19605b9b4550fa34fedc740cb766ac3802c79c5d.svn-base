          ...
          <div class="col-sm-12">
            <div class="form-group" >
             ...
             <div class="col-xs-12 col-md-12" style="border-bottom: .1em solid #ccc;"></div>
              <label style="padding-right: 10px;" >AMOUNT HOLDING : {{ json_decode($viewmember->membership_details)->inr->type }} </label>
              <label class="inr-style">AMOUNT APPLYING FOR : {{ json_decode($viewmember->membership_details)->inr->amount }} </label>
            </div>
            
            <div class="form-group">
           <p> <strong>AED</strong></p>
              <div class="col-xs-12 col-md-12" style="border-bottom: .1em solid #ccc;"></div>
              <label style="padding-right: 10px;">AMOUNT HOLDING : {{ json_decode($viewmember->membership_details)->aed->type }} </label>
              <label class="inr-style">AMOUNT APPLYING FOR : {{ json_decode($viewmember->membership_details)->aed->amount }} </label>
            </div>
            <div class="form-group">
            <p><strong>INR</strong></p>
               <div class="col-xs-12 col-md-12" style="border-bottom: .1em solid  #ccc;"></div>
              <label style="padding-right: 10px;">AMOUNT HOLDING : {{ json_decode($viewmember->membership_details)->cad->type }} </label>
              <label class="inr-style" >AMOUNT APPLYING FOR : {{ json_decode($viewmember->membership_details)->cad->amount }} </label>
            </div>
           
            <div class="form-group">
              <p><strong>USD</strong></p>
            <div class="col-xs-12 col-md-12" style="border-bottom:.1em solid #ccc;"></div>
              <label style="padding-right: 10px;">AMOUNT HOLDING : {{ json_decode($viewmember->membership_details)->usd->type }} </label>
              <label class="inr-style">AMOUNT APPLYING FOR : {{ json_decode($viewmember->membership_details)->usd->amount }} </label>
            </div>
              <div class="form-group">
              <p><strong>SAR</strong></p>
              <div class="col-xs-12 col-md-12" style="border-bottom: .1em solid #ccc;"></div>
              <label style="padding-right: 10px;">AMOUNT HOLDING : {{ json_decode($viewmember->membership_details)->sar->type }} </label>
              <label class="inr-style">AMOUNT APPLYING FOR : {{ json_decode($viewmember->membership_details)->sar->amount }} </label>
            </div>
          </div>
        </div>
      </div>
