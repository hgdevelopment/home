...
<!-- <header id="header" style="text-align:center;/*padding-top: -30px;*/ ">
  ...
  <figcaption class="main_head"><?php echo e(ucfirst($employee_details->company_name)); ?></figcaption>
  <figcaption class="sub_head"> <?php echo e(ucfirst($employee_details->branch_name)); ?>

                <?php echo e(ucfirst($employee_details->address1)); ?>,
                  <?php echo e(ucfirst($employee_details->city)); ?>,
                <?php echo e(ucfirst($employee_details->state)); ?>, <?php echo e(ucfirst($employee_details->countryName)); ?>, <?php echo e(ucfirst($employee_details->pinNo)); ?></figcaption>
</figure>
...
<div>
<img src="<?php echo e(URL::to('/')); ?>/img/tcnmaster/appointment.png" alt="" style="width: 100%;" />
  <br>
    <br>
      <br>
    <br>
    ...
    <div style="margin-left: 85px;padding-top: -20px;line-height: 13px;">
        <table width="100%">
            ...
            <tr><td ><?php echo e(ucfirst($employee_details->salutation_name)); ?><?php echo e(ucfirst($employee_details->name)); ?></td></tr>
            <tr><td ><?php echo e(ucfirst($employee_details->useraddress)); ?>,</td></tr>
            <tr><td ><?php echo e(ucfirst($employee_details->usercity)); ?>,</td></tr>
            <tr><td ><?php echo e(ucfirst($employee_details->userstate)); ?>,</td></tr>
            <tr><td ><?php echo e(ucfirst($employee_details->countryName)); ?>,</td></tr>
            <tr><td ><?php echo e(ucfirst($employee_details->userzipcode)); ?></td></tr>
            <tr><td >&nbsp;</td></tr>
            <tr><td></td></tr>
            <tr><td>Dear <?php echo e(ucfirst($employee_details->salutation_name)); ?><?php echo e(ucfirst($employee_details->name)); ?>,</td></tr>        
        </table>
    </div>
        ...
        <table width="630px" align="center" >
            <tr style="padding-top: 0px;padding-bottom: 0px;" >
                ...
                <td width="590px" valign="top" >
                   Your initial designation will be <b><?php echo e(ucfirst($employee_details->designation_name)); ?>
            ...
            <tr >
                ...
                <td width="590px" valign="top"  style="text-align: justify;" >
                    You will be paid a consolidated Salary of Rs.&nbsp;<b><?php echo e($employee_details->salary); ?></b> per month. 
                </td>
            </tr>
    ...
    <div style="padding-left:110px;">
        <table width="630px" align="center">
            ...
            <tr>
                <td width="10" valign="right"  ><b><?php echo e($key++); ?>. </b></td>
                <td width="590px" valign="top" ><b><?php echo e($salaries->allowances); ?> : <?php echo e($employee_details->salary * ($salaries->percentage / 100)); ?></b></td>
    ...
    <div >
        <table width="630px" align="center">
            ...
            <tr >
                ...
                <td width="590px" valign="top"  style="text-align: justify;">
                 Your Date of Birth as given by you is 
                        <b><?php  $date = new Carbon( $employee_details->dob )  ?>
                        <?php echo e($date->format('d/m/Y')); ?></b>
            ...
            <tr>
                ...
                <td width="590px" valign="top"  style="text-align: justify;">
                    You are requested to report for duty on or before <b><?php  $date = new Carbon( $employee_details->date_of_joining )  ?>
                        <?php echo e($date->format('d/m/Y')); ?></b>, at 10am . In case you fail to report for duty on this date, the offer shall stand automatically withdrawn.
                </td>
            </tr>
            <tr>
...
<!-- 
    ...
    <div style="padding-left: 80px;">
        ...
        <tr><td valign="top"><b>For&nbsp;<?php echo e(ucfirst($employee_details->company_name)); ?></b></td></tr>
        </table>
        <table width="630px" align="center">
        <tr><td align="left"><img src="<?php echo e(URL::to('/')); ?>/signature.jpg"></td></tr>
