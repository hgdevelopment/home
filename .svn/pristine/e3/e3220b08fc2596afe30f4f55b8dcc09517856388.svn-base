          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="input-group m-b">
                ...
                <input type="text" class="form-control" placeholder="Mobile No" id="mobileno" name="mobileno" value="<?php echo e(old('mobileno')); ?>" required data-parsley-maxlength="16" data-parsley-maxlength-message="Please enter valid phone no" data-parsley-type="integer" data-parsley-trigger="keyup" >
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="Pin" data-parsley-trigger="keyup" required data-parsley-maxlength="6" data-parsley-minlength="1" data-parsley-type="integer" data-parsley-minlength-message="Please enter valid pin" id="permanent_pin" name="permanent_pin" value="<?php echo e(old('permanent_pin')); ?>">
  ...
  <div class="col-sm-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <label>Pin<span style="color:red;">*</span></label>
          <input type="text" id="correspondance_pin" name="correspondance_pin" class="form-control" required data-parsley-maxlength="6" data-parsley-minlength="1" data-parsley-minlength-message="Please enter valid pin" data-parsley-trigger="keyup" placeholder="Pin" data-parsley-type="integer"  value="<?php echo e(old('correspondance_pin')); ?>">
  ...
  <div class="col-sm-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <label>Pin</label>
          <input type="text" class="form-control" data-parsley-maxlength="6" data-parsley-minlength="1" data-parsley-minlength-message="Please enter valid pin" data-parsley-trigger="keyup" placeholder="Pin" id="official_pin" name="official_pin" data-parsley-type="integer" value="<?php echo e(old('official_pin')); ?>">
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-6">
                ...
                <input type="text" name="type_amount_inr" id="type_amount_inr" placeholder="INR">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label>AMOUNT OF HOLDING(IF ANY)</label>
                <input type="text" name="type_amount_aed" id="type_amount_aed" placeholder="AED">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label>AMOUNT OF HOLDING(IF ANY)</label>
                <input type="text" name="type_amount_usd"  id="type_amount_usd" placeholder="USD">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label>AMOUNT OF HOLDING(IF ANY)</label>
                <input type="text" name="type_amount_sar"  id="type_amount_sar" placeholder="SAR">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                <label>AMOUNT OF HOLDING(IF ANY)</label>
                <input type="text" name="type_amount_cad" id="type_amount_cad" placeholder="CAD">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="form-horizontal">
              ...
              <input type="text" class="form-control img-bg " value="<?php echo e($captcha); ?>" name="captcha" id="captcha" disabled="disabled"></div>
              <div class="col-sm-6 col-xs-12">
