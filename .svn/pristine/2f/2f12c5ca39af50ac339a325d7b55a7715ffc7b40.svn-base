...
<div> &nbsp;</div>
  <div class="section">
 <div class="header-bar">
  <h3 class="heading-1">Trade Payment Details
</h3>
 </div>
   <table class="table-data personal-details">
...
<div class="clear-fix"></div>
 <div class="section">
 <div class="header-bar">
  <h3 class="heading-1">Nominee Details(1)
</h3>
 </div>
   <table class="table-data personal-details">
...
<div class="clear-fix"></div>
 <div class="section">
 <div class="header-bar">
  <h3 class="heading-1">Nominee Details(2)
</h3>
 </div>
   <table class="table-data personal-details">
...
<?php endif; ?>
 ...
 <div class="section">
 <div class="header-bar">
  <h3 class="heading-1">Introduction Details
</h3>
 </div>
