        ...
        <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group" style="float:left;">
                <input type="hidden" name="signature1" value="{{$nominees->signature}}"> 
                <img src="{{URL::to('/') }}/storage/img/nominee/{{$nominees->signature}}" style="width: 150px;height: 150px;cursor: pointer;" />
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <img src="{{URL::to('/') }}/storage/img/proof/{{$proofs->file}}" style="width: 150px;cursor: pointer;height: 150px" />
