...
<div class="wrapper-md" ng-controller="FormDemoCtrl">
	<form role="form" method="post" id="form"  action="{{URL::to('/') }}/admin/tcnFullWithDrawal/{{ $withDraws->id }}" data-parsley-validate >
		...
		<div class="panel panel-warning">
			...
			<div class="col-sm-4 font-bold text-success h4">TCN TYPE : <span class="text-danger">{{$tcnrequests->tcn->tcnType}}</span></div><div class="col-sm-4 font-bold text-success h4">WITHDRAW STATUS : <span class="text-danger">{{$withDraws->status}}</span></div>&nbsp;
			</div>
		</div>
			...
			<div class="panel-body">
				...
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-3">
	                      <input type="text" class="form-control" data-date-end-date="0d" id="wdappliedDate" name="wdappliedDate" value="{{date('d-m-Y',strtotime($withDraws->appliedDate))}}" required data-parsley-required-message="Please Enter Withdrawal applied date" readonly>					
						</div>
				...
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-3">
							<input type="text" name="debitAccountNo" id="debitAccountNo" value="{{ $tcnrequests->heeraaccount->accountNumber }}" class="form-control" required data-parsley-required-message="Please Enter Debit acc No.(Heera's)" onblur="heeraAccountCheck(this.value)"/>
						</div>
				...
				<input type="hidden" name="withDrawId" id="withDrawId" value="{{$tcnrequests->withDrawId}}"> 
