...
<div class="bg-light lter b-b wrapper-md">
	...
	<form action="<?php echo e(URL::to('/')); ?>/admin/reassignmember/view" method="post"  id="form" data-parsley-validate>
	...
	<form action="<?php echo e(URL::to('/')); ?>/admin/reassignmember/solve" method="post" name="form1" id="form1">
	<?php echo e(csrf_field()); ?>
