...
<div class="row">
   ...
   @if($tcnDetails->reason!=='')

    <div class="row">
      <div class="col-sm-12">
      <div class="panel panel-warning">
        <div class="panel-heading">Reason {{-- <a href="#" class="pull-right" data-toggle="modal" data-target="#profile_details"><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i> Edit</a> --}}</div>
