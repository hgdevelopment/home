...
<div class="wrapper bg-white b-b">
      <ul class="nav nav-pills nav-sm">
        ...
        <li class="active"><a href="{{ URL::to('/') }}/admin/tcnApplicationForm">Application Form</a></li>
        @endif
			...
			<div class="panel-body">
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-4">
							@if(isset($Edit))
							<img src="{{URL::to('/') }}/storage/img/tcndocs/{{$Edit['doc1']}}" style="height:200px;width:200px;cursor: pointer;"  onclick="window.open('{{URL::to('/') }}/storage/img/tcndocs/{{$Edit['doc1']}}')">
							@endif
							...
							if(!isset($Edit)) echo 'required data-parsley-required-message="Select Document 1" data-parsley-max-file-size="50" ';  @endphp onchange="imageCheck(this)">
						...
						<div class="col-sm-4">
							@if(isset($Edit))
							<img src="{{URL::to('/') }}/storage/img/tcndocs/{{$Edit['doc2']}}" style="height:200px;width:200px;cursor: pointer;"  onclick="window.open('{{URL::to('/') }}/storage/img/tcndocs/{{$Edit['doc2']}}')">
							@endif
						...
						<div class="col-sm-4">
							@if(isset($Edit))
							<img src="{{URL::to('/') }}/storage/img/tcndocs/{{$Edit['doc3']}}" style="height:200px;width:200px;cursor: pointer;"  onclick="window.open('{{URL::to('/') }}/storage/img/tcndocs/{{$Edit['doc3']}}')">
							@endif
...
function getNomineeDetails(n)
{
	...
	if(nominee==' ' || nominee==null)
	{
		if(n==2)
		{
		$("#getNomineeDetails2 *").find("select, input ,textarea").attr('required',false);
		$("#nomineePhotos2 *").find("select, input ,textarea").attr('required',false);
		}
	...
	if(n==2 && nominee!=' ')
	{
		...
		{
		$("#getNomineeDetails2 *").find("select, input ,textarea").attr('required',true);
