				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="dob" id="dob" data-language="en"  onchange="check()"  placeholder="DOB" required data-parsley-required-message="Please Select DOB" value="{{ old('dob')}}" readonly="">
					...
					<div class="col-sm-4">
						...
						<div class="input-group m-b">
			              <span class="input-group-addon conId" required data-parsley-required-message="Please Select Country" value="{{ old('telePhoneNo')}}"></span>
			              <input type="hidden" id="conId" name="conId" value="">
			              <input type="text" class="form-control" placeholder="mobileNo" required data-parsley-required-message="Please Enter Mobile Number" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="16" name="mobileNo" id="mobileNo"  data-parsley-type="integer" value="{{ old('mobileNo')}}">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Telephone No"  name="telePhoneNo" id="telePhoneNo" data-parsley-type="integer" data-parsley-trigger="keyup" data-parsley-minlength="1" value="{{ old('telePhoneNo')}}">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<textarea type="text" class="form-control" placeholder="Address" required data-parsley-required-message="Please Enter Address " data-parsley-trigger="keyup" data-parsley-minlength="1" name="permanentAddress" id="permanentAddress">{{ old('permanentAddress')}}</textarea>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="City"  data-parsley-required-message="Please Enter City " name="permanentCity" id="permanentCity" value="{{ old('permanentCity')}}">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<textarea type="text" class="form-control" placeholder="Address" required data-parsley-required-message="Please Enter Address " data-parsley-trigger="keyup" data-parsley-minlength="1" name="corrsAddress" id="corrsAddress">{{ old('corrsAddress')}}</textarea>
	...
	<div class="col-sm-4">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					<label>Address</label>
					<textarea type="text" class="form-control" placeholder="Address" data-parsley-trigger="keyup" data-parsley-minlength="1" name="officialAddress" id="officialAddress">{{ old('officialAddress')}}</textarea>
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="form-group " style="position: relative;">
						...
						<input type="file" class="btn btn-success btn-fil  "  style="width: 100%;" placeholder="Branch" required data-parsley-required-message="Please Upload Proof" name="Accproof" id="Accproof" accept="image/png,image/jpeg" onchange="proofAcccheck();accSize(this)" style="background-color:#27c24c;" value="{{ old('companyName')}}">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Deposit Date" name="depositDate" required data-parsley-required-message="Please Select Date"  id="depositDate" data-date-end-date="0d" value="{{ old('depositDate')}}" readonly="">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Mobile No" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-maxlength="16" name="refMobileNo" id="refMobileNo" data-parsley-type="integer" value="{{ old('refMobileNo')}}">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
          			...
          			<div class="col-sm-6">
            			<div class="form-group" >
			              ...
			              <select class="form-control" id="addedByUnder" name="addedByUnder" required="please select Assigned Member">
				              <option value="">Select</option>
				              <option value="MYSELF" {{ (old('addedByUnder')=='MYSELF')?'selected':'' }}>MYSELF</option>
				              <option value="ME" {{ (old('addedByUnder')=='ME')?'selected':'' }}>ME</option>
			              </select>
			              @if ($errors->has('addedByUnder'))
			              	<span class="help-inline">{{$errors->first('addedByUnder')}}</span>
			              @endif
			            </div>
          			</div>
