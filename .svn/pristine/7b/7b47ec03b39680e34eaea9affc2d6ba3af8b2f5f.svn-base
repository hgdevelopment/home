				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="file" class="btn btn-success btn-fil" required data-parsley-required-message="Please Upload Photo" name="photo" id="photo" accept="image/png,image/jpeg">
						</div>
						@if ($errors->has('photo'))
