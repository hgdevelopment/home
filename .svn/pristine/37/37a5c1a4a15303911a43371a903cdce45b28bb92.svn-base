  ...
  <div style="margin-top:5px">
    <div class="section" style="float:right; margin:5px 10px 0 0">
      <table style="border:1px solid">
        <tbody>
          <tr>
            <td><img class="profile-img" src="{{URL::to('/') }}/storage/img/member_img/{{$tcnrequest->member->photo
    ...
    <div class="section" style="float:left; margin:100px 0 0 10px">
      <table>
        <tbody>
          <tr>
            <th>MEMBER CODE</th><th>: {{ucfirst($tcnrequest->member->code)}} </th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <th>TCN CODE</th><th>: {{ucfirst($tcnrequest->tcnCode)}} </th>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          <tr>
            <td>NAME</td><th>: {{ucfirst($tcnrequest->member->name)}}</th>
            <td>RELIGION</td><th>: {{ucfirst($tcnrequest->member->religion)}}</th>
          </tr>
          <tr><td></td></tr>
          <tr>
          ...
          <tr>
            ...
            <td>DATE OF BIRTH</td><th>: {{$tcnrequest->member->dob}}</th>
          </tr>

          <tr>
            <td>EDUCATION</td><th>:{{$tcnrequest->member->education}}</th>
            <td>FATHER'S / HUSBAND'S NAME</td><th>: {{$tcnrequest->member->guardian}}</th>
          </tr>
          <tr>
...
@if(in_array($element->typeOfAddress,array('permanent','official','correspondance'))) 
    <div class="section">
      <div class="header-bar">
        <h3 class="heading-1" style="background-color:#bcd688">{{($element->typeOfAddress=='correspondance')?'Correspondence':ucfirst($element->typeOfAddress)}} Address</h3>
      </div>
      <table class="table-data personal-details">
        <tbody>
          <tr>
            <td>ADDRESS</td><th>: {{$element->address}}</th>
            <td>CITY</td><th>: {{ $element->city }}</th>
          </tr>
          <tr><td></td></tr>
          <tr>
            <td>STATE</td><th>: {{ $element->state }}</th>
            <td>PIN CODE</td><th>: {{ $element->pin }}</th>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          ...
          <tr>
            <td>ACCOUNT NUMBER</td><th>: {{$tcnrequest->benefit->accountNumber}}</th>
            <td>BANK NAME</td><th>: {{$tcnrequest->benefit->bankName}}</th>
          </tr>
          <tr><td></td></tr>
          <tr>
  ...
  <br><br><br>
    ...
    <div class="section">
      ...
      <table class="table-data personal-details">
        <tbody>
          <tr>
            <td>CURRENCY</td><th>: {{$tcnrequest->currencyType}}</th>
            <td>NO OF UNITS</td><th>: {{$tcnrequest->unit}}</th>
          </tr> 
          <tr>
          ...
          <tr>
            <td>DATE</td><th>: {{$tcnrequest->depositeDate}}</th>
  ...
  <div style="page-break-after: always;"></div>
    <div class="section">
      ...
      {{-- <table style="border:1px solid;">
        <tbody>
          <tr>
            <td><img class="profile-img" src="{{URL::to('/') }}/storage/img/nominee/{{$tcnrequest->nominee_one->uploadPhoto
    }}" alt="" width="120" height="150" style="float: right;"></td>
          </tr>
        </tbody>
      </table> --}}
   ...
   {{--   <caption>table title and/or explanatory text</caption> --}}
    <tbody>
      <tr>
        ...
        <td colspan="3"><img class="profile-img" src="{{URL::to('/') }}/storage/img/nominee/{{$tcnrequest->nominee_one->uploadPhoto
    }}" alt="" width="120" height="150" style="float: right;"></td>
      </tr>
      <tr>
          <td>GENDER</td>
        <th>{{ucfirst($tcnrequest->nominee_one->gender)}}</th>
        <td style="width:200px;">RELATION WITH APPLICANT</td>
   ...
   <br/>
   <br/>
   <table class="table-data personal-details" style="width: 600px;">
   {{--   <caption>table title and/or explanatory text</caption> --}}
    <tbody>
      <tr>
        <td>ADDRESS</td>
        <th >{{$tcnrequest->nominee_one->address->address}}</th>
        <td>EMAIL</td>
...
<br/>
   ...
   {{--   <caption>table title and/or explanatory text</caption> --}}
    <tbody>
      <tr>
        ...
        <td colspan="3"><img class="profile-img" src="{{URL::to('/') }}/storage/img/nominee/{{$tcnrequest->nominee_two->uploadPhoto
    }}" alt="" width="120" height="150" style="float: right;"></td>
      </tr>
      <tr>
          <td>GENDER</td>
 ...
 <div class="pull-right" style="margin-right: 60px;">SIGNATURE: <br/><br/><img src="{{URL::to('/') }}/storage/img/nominee/{{$tcnrequest->nominee_two->signature}}" width="130" height="60" alt="" />
 <br/>
