	...
	<div class="col-lg-12">
		<div class="row">
			<div class="panel panel-warning">
				...
				<div class="panel-body">
					<?php if($tcnrequests->status!='Transferred'): ?>
					  ...
					  <div class="col-md-6 col-xs-12 divTableCell">Applied Date<b class="data-lab"><?php echo e(date('d-m-Y',strtotime($tcnrequests->addedDate))); ?></b></div>
	                        ...
	                        <div class="col-md-6 col-xs-12 divTableCell">Payment Status<b class="data-lab"><?php echo e($tcnrequests->paymentReceived); ?></b></div>
		                        ...
		                        <div class="col-md-6 col-xs-12 divTableCell">Doc Verified By<b class="data-lab"><?php echo e(TCNuserID($tcnrequests->docVerifiedId)); ?></b></div>
						...
						foreach($payment as $payment)
                         ...
                         <div class="col-md-6 col-xs-12 divTableCell">Remarks<b class="data-lab"><?php echo e($payment->remarks); ?></b></div>
	                         <?php if($tcnrequests->transferredReason!=''): ?>
	                         <div class="col-md-6 col-xs-12 divTableCell">Transferred TCN  <b class="data-lab"><?php echo e($tcnrequests->transferredReason); ?></b></div>
	                         <?php endif; ?>
	                    <?php endif; ?>
                         ...
                         <div class="col-md-6 col-xs-12 divTableCell">TCN Transferred By<b class="data-lab"><?php echo e(TCNuserID($tcnrequests->addedId)); ?></b></div>
                        
                         <div class="col-md-6 col-xs-12 divTableCell">Reason<b class="data-lab"><?php echo e($tcnrequests->transferredReason); ?></b></div>
                         <?php endif; ?>
				</div>
			</div>
		</div>	
