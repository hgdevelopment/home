...
<div class="wrapper-md" ng-controller="FormDemoCtrl">
	<form role="form" method="post" id="form"  action="<?php echo e(URL::to('/')); ?>/admin/tcnFullWithDrawal/<?php echo e($withDraws->id); ?>" data-parsley-validate >
		...
		<div class="panel panel-warning">
			...
			<div class="col-sm-4 font-bold text-success h4">TCN TYPE : <span class="text-danger"><?php echo e($tcnrequests->tcn->tcnType); ?></span></div><div class="col-sm-4 font-bold text-success h4">WITHDRAW STATUS : <span class="text-danger"><?php echo e($withDraws->status); ?></span></div>&nbsp;
			</div>
		</div>
