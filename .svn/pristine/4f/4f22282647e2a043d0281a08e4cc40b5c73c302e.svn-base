              ...
              <div class="row">
                  ...
                  <div class="form-group col-md-10">
                      <label>ASSIGN EMPLOYEE CODE *</label>
                       <input type="text" class="form-control" name="employee_code"  id="employee_code" required data-parsley-required-message="Please Enter Employee Code"   value="@yield('employee_code')" data-parsley-pattern="^[a-zA-Z0-9_ ]*$"  placeholder="Employee Code" >
