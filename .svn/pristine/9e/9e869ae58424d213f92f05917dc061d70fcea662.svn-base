          ...
          <div class="row">
           ...
           <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="No of Units"  name="no_of_units" id="no_of_units" value="<?php echo e(old('no_of_units')); ?>" data-parsley-required-message="No of Units is required" data-parsley-trigger="blur" data-parsley-pattern="^[1-9][0-9]{0,2}$" required>
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="DD/Cheque/UTR/Ref." data-parsley-trigger="blur"  name="payment_type" id="payment_type" value="<?php echo e(old('payment_type')); ?>" data-parsley-required-message="Deposit Date is required" required>
        ...
        <div class="panel-body">
            <div class="form-group">
              ...
              <select name="select_nominee_two" id="select_nominee_two" class="form-control" data-parsley-required-message="Please select Nominee" required data-parsley-trigger="blur" data-parsley-notequalto="#select_nominee">
                <option value="" data-id="0">Select</option>
                <?php $__currentLoopData = $nominee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <option value="<?php echo e($element->id); ?>" data-id="<?php echo e($element->userId); ?>" <?php echo e((old('select_nominee_two')==$element->id)?'selected':''); ?>><?php echo e($element->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
