...
"enabled": true
	...
	<tbody>
		...
		<a href="{{ URL::to('/') }}/admin/tcnApplicationForm/{{'view@@@'}}{{encrypt($detail->tcnId)}}" class="active"><i style="color: #018001;" class="fa fa-search text-success text-active" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
		 <a href="{{ URL::to('/') }}/admin/tcnApplicationForm/{{encrypt($detail->tcnId)}}/edit" class="active"><i class="fa fa-pencil text-danger text-active" aria-hidden="true"></i></a>    
		</td>
		</tr>
		<?php $i++;?>
		@endforeach
