...
<br>
<form action="{{URL::to('/') }}/admin/dsa/@yield('edit_id')" method="post" data-parsley-validate enctype="multipart/form-data">
	{{ csrf_field() }}
	@section('edit')
     @show
		<div class="col-sm-12">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="dob" id="dob" placeholder="Date of Birth"  data-language="en"  onchange="check()" value="@yield('dob')">
					...
					<div class="col-sm-4">
						<div class="form-group">
			              ...
			              <input type="hidden" id="conId" name="conId" value="@yield('mobileId')">
							<input type="text" class="form-control" placeholder="Mobile No" required data-parsley-required-message="Please Enter Mobile Number" data-parsley-trigger="keyup" data-parsley-minlength="5" data-parsley-maxlength="16" name="mobileNo" id="mobileNo" value="@yield('mobileNo')" data-parsley-type="integer">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Telephone No"  name="telePhoneNo" id="telePhoneNo" data-parsley-type="integer" value="@yield('telePhoneNo')" data-parsley-trigger="keyup" data-parsley-minlength="11">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<textarea type="text" class="form-control" placeholder="Address" required data-parsley-required-message="Please Enter Address " data-parsley-trigger="keyup" data-parsley-minlength="20" name="permanentAddress" id="permanentAddress">@yield('permanentAddress')</textarea>
	...
	<div class="col-sm-4">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					<label>Address<span style="color:red;"> *</span></label>
					<textarea type="text" class="form-control" placeholder="Address" required data-parsley-required-message="Please Enter Address " data-parsley-trigger="keyup" data-parsley-minlength="20" name="corrsAddress" id="corrsAddress">@yield('corrsAddress')</textarea>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					<label>Address</label>
					<textarea type="text" class="form-control" placeholder="Address"  data-parsley-trigger="keyup" data-parsley-minlength="20" name="officialAddress" id="officialAddress">@yield('officialAddress')</textarea>
				</div>
				<div class="form-group">
					<label>City</label>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Deposit Date" name="depositDate" required data-parsley-required-message="Please Select Date"  id="depositDate" value="@yield('depositDate')"  data-language="en" data-date-end-date="0d">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Mobile No" data-parsley-trigger="keyup" data-parsley-minlength="10" data-parsley-maxlength="14" name="refMobileNo" id="refMobileNo" value="@yield('refMobileNo')" data-parsley-type="integer">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
			...
			<div class="panel-body">
				<div class="form-horizontal">
					...
					<div class="col-sm-4 col-sm-offset-5">
						...
						{{-- <a href="{{ URL::to('/') }}/admin/dsa/{{ $dsaDetails->userId}}/edit"  class="active"><button type="button" class="btn btn-danger" name="edit" id="edit">Back</button></a> --}}
				</div>
			</div>
		</div>
	</div>
