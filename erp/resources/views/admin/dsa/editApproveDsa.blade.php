  ...
  <div class="wrapper-lg bg-white-opacity">
    <div class="row m-t">
      <div class="col-sm-12">
          ...
          <img src="{{ URL::asset('storage/img/payProof/'.$dsapaymentdetails->file)}}" draggable="true"  class="img-thumbnail " alt="" style="width: 100px;height:130px;" /><span style="margin-left: 30px;">PROOF</span><br> <span class="h6-text text-black" style="text-transform: uppercase;">Proof Type : &nbsp;{{$dsaProof->typeOfProof}}</span><br> <span class="h6-text text-black" style="text-transform: uppercase;">ID Number : &nbsp;{{$dsaProof->proofNumber}}</span></a>
...
<div class="col-sm-6">
  ...
  <div class="col-sm-12"></div>
  @if($dsaDetails->status=="Active")
  <div class="col-sm-12">
    <div class="panel panel-warning">
      <div class="panel-heading font-bold">Action</div>
      <div class="panel-body">
        <div class="col-sm-4 col-sm-offset-5">
          <a onclick="destroy({{ $dsaDetails->userId }})"> <button type="button" class="btn btn-danger" name="remove" id="remove">Remove</button></a>
          <a href="{{ URL::to('/') }}/admin/dsa/UpdateApproveDsa/{{ $dsaDetails->userId}} "  class="active"><button type="button" class="btn btn-info" name="edit" id="edit">Edit</button></a>
         {{--   @if($dsaDetails->status=="Block")
          <a onclick="destroy({{$dsaDetails->userId}})"><button type="button" class="btn btn-danger" name="delete" id="delete">Delete</button></a>
          @endif --}}
        </div>
      </div>
    </div>
...
<script type="text/javascript">
    ...
    if (isConfirm) {
    $.ajax({
    url: "{{ URL::to('admin/delete/blocklist') }}",
    type: "get",
    ...
    setTimeout(function() {
    window.location.href = "{{ URL::to('admin/dsa/viewApproveDsa') }}";
    }, 2000);
    },
