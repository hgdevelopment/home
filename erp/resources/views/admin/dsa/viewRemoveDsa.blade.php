        ...
        <table class="table table-striped table-bordered dt-responsive nowrap b-t" cellspacing="0" width="100%" id="dsaRequest">
          ...
          @foreach($dsa as $key => $dsas)
            <tr>
             ...
             <td><a href="{{ URL::to('/') }}/admin/dsaApprove/{{ $dsas->userId}}/edit"  class="active"><i  style="color: #018001;" class="fa fa-search text-success text-active" aria-hidden="true"></i></a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
