    ...
    <div class="row m-t">
      ...
      {{ csrf_field() }}
        <div class="col-sm-12">
          ...
          <img src="{{ URL::asset('storage/img/proof/'.$memb->file)}}" draggable="true"  class="img-thumbnail " alt="" style="width: 100px;height:130px;" /><span style="margin-left: 30px;">PROOF</span><br> <span class="h6-text text-black" style="text-transform: uppercase;">Proof Type : &nbsp;{{$memb->typeOfProof}}</span><br> <span class="h6-text text-black" style="text-transform: uppercase;">ID Number: &nbsp;{{$memb->proofNumber}}</span></a>
  ...
  <div class="row" style="padding-bottom: 20PX;">
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body">
          @foreach($countryaddress as $name)
          @foreach($mem as $deniedaddress)
          @if(($deniedaddress->typeOfAddress=='permanent')&&($name->type=='permanent'))
          <div class="col-md-12 col-xs-12 divTableCell">Address <b class="data-lab">{{$deniedaddress->address}}</b></div>
          <div class="col-md-12 col-xs-12 divTableCell">City<b class="data-lab">{{$deniedaddress->city}}</b></div>
          <div class="col-md-12 col-xs-12 divTableCell">State<b class="data-lab"> {{$deniedaddress->state}}</b></div>
          <div class="col-md-12 col-xs-12 divTableCell">Country<b class="data-lab">{{$name->Names}}</b></div>
          <div class="col-md-12 col-xs-12 divTableCell">Pin<b class="data-lab">{{$deniedaddress->pin}}</b></div>
          @endif
          @endforeach
          @endforeach
        </div>
    ...
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body">
          @foreach($countryaddress as $name)
          @foreach($mem as $deniedaddress)
          @if(($deniedaddress->typeOfAddress=='correspondance')&&($name->type=='correspondance'))
          <div class="col-md-12 col-xs-12 divTableCell">Address <b class="data-lab">{{$deniedaddress->address}}</b></div>
          <div class="col-md-12 col-xs-12 divTableCell">City<b class="data-lab">{{$deniedaddress->city}}</b></div>
          <div class="col-md-12 col-xs-12 divTableCell">State<b class="data-lab"> {{$deniedaddress->state}}</b></div>
          <div class="col-md-12 col-xs-12 divTableCell">Country<b class="data-lab">{{$name->Names}}</b></div>
    ...
    <div class="col-sm-12 col-md-6 padder-ad">
      <div class="panel panel-warning" >
        ...
        <div class="panel-body">
          @foreach($countryaddress as $name) @endforeach
          @foreach($mem as $deniedaddress)
