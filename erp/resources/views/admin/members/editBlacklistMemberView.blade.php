@extends('admin.layout.erp1')
  ...
  <div class="bg-light lter b-b wrapper-md">
   <h1 class="m-n font-thin h3">Edit Blacklisted Member</h1>
  </div>
  <div class="wrapper-md">
    <div class="row">
      <div class="col-sm-12">
        <div class="blog-post">                   
          <div class="col-sm-12">
            <form role="form" method="POST" action="{{URL::to('/') }}/admin/member/blacklistMember/@yield('edit_id')" data-parsley-validate enctype="multipart/form-data">
              {{csrf_field()}}
              @section('edit')
              @show
                 ...
                 <div class="form-group col-sm-4">
                  ...
                  <div class="form-group col-sm-4" >
                    ...
                    @if(isset($blacklistedit->id))
                      ...
                      <img src="{{ URL::asset('storage/img/member_img/'.$blacklistedit->photo)}}" style="width:100px;height:100px;">
                      <input type="hidden" name="photo_update" value="{{$blacklistedit->photo}}">
                    @endif
                  </div>
                  <div class="form-group col-sm-4">
                    ...
                    @if(isset($blacklistedit->id))
                      ...
                      <img src="{{ URL::asset('storage/img/member_img/'.$blacklistedit->singnature)}}" style="width:100px;height:100px;">
                      <input type="hidden" name="sign_update" value="{{$blacklistedit->singnature}}">
                    @endif
                  </div>
                </div>
              </div>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group col-sm-12">
                        ...
                        <input type="text" name="per_pin" id="per_pin" value="@yield('per_pin')" required data-parsley-required-message="Please Enter Pin Number" data-parsley-trigger="keyup" data-parsley-maxlength="6" data-parsley-type="integer" class="form-control" >
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group col-sm-12">
                        <label>Pin<span style="color:red;">*</span></label>
                        <input type="text" name="corr_pin" id="corr_pin" value="@yield('corr_pin')" required data-parsley-required-message="Please Enter Pin Number" data-parsley-trigger="keyup" data-parsley-maxlength="6" data-parsley-type="integer" class="form-control" >
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group col-sm-12">
                        <label>City</label>
                        <input type="text" name="official_city" id="official_city" value="@yield('official_city')" data-parsley-required-message="Please Enter City" class="form-control" >
                      </div>
                      <div class="form-group col-sm-12">
                        <label>State</label>
                        <input type="text" name="official_state" id="official_state" value="@yield('official_state')" data-parsley-required-message="Please Enter State" data-parsley-pattern="^[A-Z a-z]*$" data-parsley-trigger="keyup" class="form-control" >
                      </div>
                      <div class="form-group col-sm-12">
                        <label>Country</label>
                      ...
                      <div class="form-group col-sm-12">
                        <label>Pin</label>
                        <input type="text" name="official_pin" id="official_pin" value="@yield('official_pin')" data-parsley-required-message="Please Enter Pin Number" data-parsley-trigger="keyup" data-parsley-maxlength="6" data-parsley-type="integer" class="form-control" >
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <img src="{{ URL::asset('storage/img/proof/'.$blacklistproof->file)}}" style="width:100px;">
                      <input type="hidden" name="proof_update" value="{{$blacklistproof->file}}">
                      @endif
                    </div>
                  </div>
                </div>
