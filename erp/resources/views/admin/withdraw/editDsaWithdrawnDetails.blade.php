  ...
  <div class="col-sm-6">
    ...
    <div class="panel panel-warning">
      ...
      <div class="panel-body">
         ...
         <div class="col-md-3 col-xs-12 divTableCell text-center">ccount Proof  <img src="{{ URL::asset('storage/img/Accproof/'.$dsabank->Accproof)}}"  style="width:96px;height: 96px;"></div>
      </div>
    </div>
  </div>
    <div class="col-sm-4">
