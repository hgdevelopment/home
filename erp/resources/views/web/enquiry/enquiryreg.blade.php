...
<style type="text/css">
  ...
  color:red;
	...
	<form action="{{ URL::to('/') }}/enquiryreg" method="POST" enctype="multipart/form-data" data-parsley-validate>
	{{csrf_field()}}
	@section('edit')
	@show
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="col-sm-6">
									...
									<textarea  class="form-control" name="suggestion" id="suggestion" placeholder="" required data-parsley-required-message="Please Enter Suggestions"  data-parsley-minlength="20"></textarea>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="col-sm-4">
									...
									<input type="email" name="email" id="email" value="" class="form-control" placeholder="" data-parsley-trigger="change" data-parsley-required-message="Please enter email" data-parsley-type-message="Please enter valid email"> <br>
								</div>

								<div class="col-sm-4">
									<label>Mobile<span class="required" style="color:red">*</span></label>
									<input type="text" name="mobile" id="mobile" value="" class="form-control" placeholder="" data-parsley-maxlength="16" data-parsley-minlength="1" data-parsley-minlength-message="Please enter valid phone no" data-parsley-maxlength-message="Please enter valid phone no"> <br>
								</div>
