  ...
  <h3 class="heading-1">Trade Payment Datails
   ...
   <tr>
      ...
      <tr>
        ...
        <td>BANK NAME</td>
        <th><?php echo e($tcnrequest->paymentdetails->bank); ?></th>
      </tr>
      <tr>
          <td>BRANCH NAME</td>
        <th><?php echo e($tcnrequest->paymentdetails->branch); ?></th>
   ...
   <table class="table-data personal-details">
    ...
    <tbody>
      <tr>
        ...
        <td rowspan="6" style="width: 155px;"><img class="profile-img" src="<?php echo e(URL::to('/')); ?>/storage/img/nominee/<?php echo e($tcnrequest->nominee_one->uploadPhoto); ?>" alt="" width="120" height="150"></td>
      </tr>
      <tr>
          <td>GENDER</td>
