...
<form action="{{ URL::to('/') }}/admin/enquiryhandling" method="post">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="col-md-4">
									...
									<input type="text" name="assignedto" id="assignedto" value="{{$enquiryregs->employee_code }}"  class="form-control" placeholder="Assigned To" required>
								</div>
								<div class="col-md-4">
