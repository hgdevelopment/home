...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-normal h3">TCN PAYMENT VERIFICATION</h1>
</div>
				                ...
				                <td>
									<div class="btn-group dropdown">
								      ...
								      <ul class="dropdown-menu dropdown-menu-right" >
								        <li>
									        <a href="<?php echo e(URL::to('/')); ?>/admin/tcnApplicationForm/<?php echo e('view@@@'); ?><?php echo e(encrypt($tcnrequest->tcnId)); ?>">View
											</a>
										</li>

										<?php if($tcnrequest->status=='Approved' && $tcnrequest->status!='Removed'): ?>
								        <li>
									        <a href="<?php echo e(URL::to('/')); ?>/admin/tcnviewprint/<?php echo e(encrypt($tcnrequest->tcnId)); ?>" >Print
											</a>
										</li>
										<?php endif; ?>
								      ...
								      <?php if($tcnrequest->docVerified=='Pending' && $tcnrequest->status=='Pending' && Controller::UserAccessRights('TCN Document Verification')=='1' && $tcnrequest->status!='Removed'): ?>
									        <li>
										        <a href="<?php echo e(URL::to('/')); ?>/admin/tcnApplicationForm/<?php echo e(encrypt($tcnrequest->tcnId)); ?>">Document Verification
												</a>
											</li>
									  <?php endif; ?>
								      ...
								      <?php if($tcnrequest->paymentReceived=='Pending' && $tcnrequest->docVerified!='Pending'  && $tcnrequest->status=='Pending' && Controller::UserAccessRights('TCN Payment Verification')=='1' && $tcnrequest->status!='Removed'): ?> 
								        <li>
									        <a href="<?php echo e(URL::to('/')); ?>/admin/tcnApplicationForm/<?php echo e(encrypt($tcnrequest->tcnId)); ?>">Payment Verification
											</a>
										</li>
									  <?php endif; ?>
								      ...
								      <?php if($tcnrequest->status=='Denied' && Controller::UserAccessRights('TCN Reapproval')=='1'): ?>
								        <li>
									        <a href="<?php echo e(URL::to('/')); ?>/admin/tcnApplicationForm/<?php echo e(encrypt($tcnrequest->tcnId)); ?>">Reapproval
											</a>
										</li>
									  <?php endif; ?>	
										...
										<li>
										<a href="<?php echo e(URL::to('/')); ?>/admin/tcnApplicationForm/<?php echo e(encrypt($tcnrequest->tcnId)); ?>/edit">Edit
										</a>
										</li>
										<?php endif; ?>
