...
"enabled": true
	...
	<tbody>
		...
		<td align=""><?php echo e(str_replace(' ','&nbsp;',$detail->tcn->tcnType)); ?></td>
		...
		<a href="<?php echo e(URL::to('/')); ?>/admin/tcnApplicationForm/<?php echo e('view@@@'); ?><?php echo e(encrypt($detail->tcnId)); ?>" class="active"><i style="color: #018001;" class="fa fa-search text-success text-active" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
		 <a href="<?php echo e(URL::to('/')); ?>/admin/tcnApplicationForm/<?php echo e(encrypt($detail->tcnId)); ?>/edit" class="active"><i class="fa fa-pencil text-danger text-active" aria-hidden="true"></i></a>    
		</td>
		</tr>
		<?php $i++;?>
