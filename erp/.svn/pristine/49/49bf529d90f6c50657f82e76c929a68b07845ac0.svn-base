...
<div class="wrapper-md" id="wrapper-md" ng-controller="FormDemoCtrl">
		...
		<div class="panel panel-default">
			<div class="panel-heading font-bold">TCN PAYMENT DETAILS EDIT<a href="<?php echo e(URL::to('/')); ?>/admin/tcnRequest/show" class="btn btn-info btn-sm full-right" style="float: right;">LIST</a></div>
