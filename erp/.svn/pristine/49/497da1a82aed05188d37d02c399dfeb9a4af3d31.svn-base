...
<div class="wrapper-md">
  <div class="row">
    <div class="col-sm-12">
      <div class="blog-post">                   
        <div class="col-sm-12">
          <form role="form" method="POST" action="{{URL::to('/') }}/admin/approve_member/@yield('edit_id')" data-parsley-validate enctype="multipart/form-data">
            {{ csrf_field() }}
            @section('edit')
            @show
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" name="fullname" id="fullname" value="@yield('fullname')" class="form-control" readonly>
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" name="guardian" id="guardian" value="@yield('guardian')" class="form-control" readonly>
                </div>
                <div class="form-group col-sm-4">
                  <label>Date of Birth</label>
                  <input type='text' name="dateofbirth" id="dateofbirth" onchange="getAge()" data-language="en" readonly class="form-control"
                  value="@yield('dateofbirth')"/>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="input-group m-b"> 
                        ...
                        <input type="text"  name="income" id="income" value="@yield('income')" required data-parsley-type="number" data-parsley-min="1" data-parsley-trigger="keyup" class="form-control">
                ...
                <div class="form-group col-sm-4">
                  ...
                  {{($errors->first('landlineno')=='validation.phone')?'Not a valid Mobile Number':$errors->first('landlineno')}}</span>
                  @endif
                </div>
                <div class="form-group col-sm-4">
                ...
                <div class="form-group col-sm-4" >
                  ...
                  <img src="{{ URL::asset('storage/img/member_img/'.$editmember->photo)}}" style="width:100px;height:100px;">
                  <input type="hidden" name="photo_update" value="{{$editmember->photo}}">
                </div>
                <div class="form-group col-sm-4">
                  ...
                  <img src="{{ URL::asset('storage/img/member_img/'.$editmember->singnature)}}" style="width:100px;height:100px;">
                  <input type="hidden" name="sign_update" value="{{$editmember->singnature}}">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <div class="form-group col-sm-12">
                      <label>Address</label>
                      <textarea row="1" column="1" type="text" name="off_address" id="off_address" placeholder="Please Enter Address" class="form-control" style="height:5%">@yield('off_address')</textarea>
                    </div>
                    <div class="form-group col-sm-12">
                      <label>City</label>
                    ...
                    <div class="form-group col-sm-12">
                      <label>Pin</label>
                      <input type="text" name="offpin" id="offpin" value="@yield('offpin')" data-parsley-trigger="keyup" data-parsley-maxlength="6" data-parsley-type="integer" class="form-control" >
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-body">
                ...
                <div class="col-sm-12"></div>
                  <div class="form-group col-sm-6">
                    ...
                    <img src="{{ URL::asset('storage/img/proof/'.$editproof->file)}}" style="width:100px;">
                    <input type="hidden" name="proof_update" value="{{$editproof->file}}">
                  </div>
              </div>
            </div> 
            </div> 
