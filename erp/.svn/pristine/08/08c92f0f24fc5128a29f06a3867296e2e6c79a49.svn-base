            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type='text' name="dateofbirth" id="dateofbirth" readonly required placeholder="MM/DD/YYYY" data-language="en" class="form-control" onchange="getAge()" value="{{ old('dateofbirth') }}"/>
              ...
              <div class="form-group col-sm-4">
                ...
                <div class="input-group m-b">
                  ...
                  <input type="text" placeholder="0" class="form-control" required data-parsley-type="integer" data-parsley-trigger="keyup" placeholder="Mobile No"  id="mobileno" name="mobileno" value="{{old('mobileno')}}" data-parsley-maxlength="16" />
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Pin" required  id="permanent_pin" required data-parsley-trigger="keyup" data-parsley-maxlength="6" data-parsley-minlength="4" data-parsley-type="integer" name="permanent_pin" value="{{ old('permanent_pin') }}">
      ...
      <div class="col-sm-4">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              <label>Pin</label>
              <input type="text" class="form-control" placeholder="Pin" id="official_pin" name="official_pin" data-parsley-type="integer" data-parsley-trigger="keyup" data-parsley-maxlength="6" data-parsley-minlength="4" value="{{ old('official_pin') }}">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <div class="col-sm-6">
                  ...
                  <input type="file" class="btn btn-success btn-fil" placeholder="Proof File" id="proof_file" name="proof_file" required data-parsley-required-message="Please upload proof file" onchange="proofcheck();idSize(this)">
