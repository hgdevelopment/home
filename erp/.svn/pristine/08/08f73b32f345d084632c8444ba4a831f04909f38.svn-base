					...
					<div class="col-md-12">
				        ...
				        <div class="row">
				           ...
				           <div class="col-md-4">
				              ...
				              <input class="form-control"  id="openOn" name="openOn" value="@if(isset($Edit['openOn'])){{date('d-m-Y',strtotime($Edit['openOn']))}}@endif{{old('openOn')}}" required="" data-parsley-required-message="Select Open On Date" readonly="" type="text">
				            </div>
