...
<div class="wrapper-md" ng-controller="FormDemoCtrl">
	<div class="panel panel-warning">
		...
		<div class="col-sm-4 font-bold text-success h4">TCN TYPE : <span class="text-danger"><?php echo e($tcnrequests->tcn->tcnType); ?></span></div><div class="col-sm-4 font-bold text-success h4">WITHDARW STATUS : <span class="text-danger"><?php echo e($withDraws->status); ?></span></div>&nbsp;
		</div>
	</div>
