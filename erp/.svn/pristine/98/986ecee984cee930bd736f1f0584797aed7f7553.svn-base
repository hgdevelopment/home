  ...
  <h3 class="heading-1">Trade Payment Datails
   ...
   <tr>
      ...
      <tr>
        ...
        <td>BANK NAME</td>
        <th>{{$tcnrequest->paymentdetails->bank}}</th>
      </tr>
      <tr>
          <td>BRANCH NAME</td>
        <th>{{$tcnrequest->paymentdetails->branch}}</th>
   ...
   {{--   <caption>table title and/or explanatory text</caption> --}}
    <tbody>
      <tr>
        ...
        <td rowspan="6" style="width: 155px;"><img class="profile-img" src="{{URL::to('/') }}/storage/img/nominee/{{$tcnrequest->nominee_one->uploadPhoto
    }}" alt="" width="120" height="150"></td>
      </tr>
      <tr>
          <td>GENDER</td>
