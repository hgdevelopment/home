				...
				<div class="panel-body">
					...
					<div class="col-sm-12" id="paymentDiv">
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<label>Bank</label>
								<input type="text" name="bankName" id="bankName" value="<?php echo e($tcnrequests->heeraaccount->bankName); ?>" class="form-control" /><span id="error_msg" class="text-danger"></span>
							</div>

							<div class="col-sm-4">
								<label>Branch</label>
								<input type="text" name="branchName" id="branchName" value="<?php echo e($tcnrequests->heeraaccount->branchName); ?>" class="form-control" /><span id="error_msg" class="text-danger"></span>
							</div>
