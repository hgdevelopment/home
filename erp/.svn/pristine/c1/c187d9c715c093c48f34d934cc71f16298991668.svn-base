...
<div class="wrapper-md" id="wrapper-md" ng-controller="FormDemoCtrl">
		...
		<div class="panel panel-default">
			<div class="panel-heading font-bold">TCN PAYMENT DETAILS EDIT<a href="{{ URL::to('/') }}/admin/tcnRequest/show" class="btn btn-info btn-sm full-right" style="float: right;">LIST</a></div>
	...
	<form role="form" method="post" action="{{URL::to('/')}}/admin/tcnApprove" id="form" data-parsley-validate id="form">
		{{ csrf_field() }}
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-4">Received Date
							<input class="form-control" type="text" data-date-end-date="0d" id="paymentReceivedDate" name="paymentReceivedDate" value=""  >
...
function getMember()
{
	...
	$.ajax({
	type: "get",
	url: "{{URL::to('/') }}/admin/tcnApprove/create",
