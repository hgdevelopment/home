...
class tcnApplicationFormController extends Controller
{
  ...
  {   
    ...
    $signature1 = 'sign'.time().'.'.$request->signature1->getClientOriginalExtension();
    ...
    $signature2 = 'sign'.time().'.'.$request->signature2->getClientOriginalExtension();
