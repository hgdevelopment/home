         ...
         <div class="col-sm-12"><br></div>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">State<span style="color:red;">*</span>
              <input type="text" name="state1" id="state1" class="form-control" value=""    required data-parsley-required-message="Enter State"/>
            </div>
         ...
         <div class="col-sm-12"><br></div>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">Pin<span style="color:red;">*</span>
              <input class="form-control" placeholder="Pin" required data-parsley-required-message="Please Enter Pin Number" data-parsley-trigger="keyup" name="pin1" id="pin1" type="text" value=""  data-parsley-pattern="^[1-9][0-9]{4,5}$">
            </div>
            <div class="col-sm-12"><br></div>
        ...
        <div class="panel-body">
         ...
         <div class="col-sm-12"><br></div>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">State<span style="color:red;">*</span>
              <input type="text" name="state2" id="state2" class="form-control" value=""    required data-parsley-required-message="Enter State"/>
            </div>
