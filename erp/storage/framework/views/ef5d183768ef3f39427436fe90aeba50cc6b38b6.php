            ...
            <div class="col-sm-4">
              ...
              <div class="form-group col-sm-4">
                ...
                <div class="input-group m-b">
                  ...
                  <input type="text" placeholder="0" class="form-control" required data-parsley-type="integer" data-parsley-trigger="keyup" placeholder="Mobile No"  id="mobileno" name="mobileno" value="<?php echo e(old('mobileno')); ?>" data-parsley-maxlength="16" />
