  ...
  <div class="row">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        ...
        <span class="btn btn-success" onclick="blacklistView(<?php echo e($blacklistmembers->userId); ?>)">Submit</span>
...
<script type="text/javascript">
  ...
  {
  $.ajax({
  url: "<?php echo e(URL::to('admin/member/blacklistMember')); ?>/"+userId,
  type: "get",
  data: {method:'get', "_token": "<?php echo e(csrf_token()); ?>","userId": userId},
  dataType: "html",
  success: function (data) 
  {  //alert(data);  
