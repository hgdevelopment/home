            ...
            <div class="form-group">
              ...
              <select name="select_nominee" id="select_nominee" class="form-control" data-parsley-required-message="Please select Nominee" required >
                ...
                <?php $__currentLoopData = $nominee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <option value="<?php echo e($element->id); ?>" data-id="<?php echo e($element->userId); ?>" <?php echo e(($tcnrequest->nominee_id==$element->id)?'selected':''); ?>><?php echo e($element->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="panel panel-default">
          ...
          <div class="row">
           ...
           <div class="col-sm-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="No of Units"  name="no_of_units" id="no_of_units" value="<?php echo e($tcnrequest->unit); ?>" data-parsley-required-message="No of Units is required" required>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              <label>Amount</label>
              <input type="text" class="form-control" placeholder="Amount"  name="amount" id="amount" value="<?php echo e($tcnrequest->amount); ?>" readonly data-parsley-required-message="Amount is required" required>
         ...
         <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Deposit Date"  name="deposite_date" id="deposite_date" value="<?php echo e($tcnrequest->depositeDate); ?>" data-parsley-required-message="Deposit Date is required" required>
...
<script  type="text/javascript" >
  $(function(){
    ...
    $('#select_nominee, #benifit_account_bank').trigger('change');
    heeraaccount_allots();
  });
</script>
<?php $__env->stopSection(); ?>
