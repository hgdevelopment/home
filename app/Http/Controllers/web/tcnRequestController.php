...
class tcnRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('web.member.tcn.tcnRequest',compact('userProfile','tcnStatus','userCode')); 
    }
    ...
    session()->flash('currencyType',$request->currencyType);
    ...
    public function listTcnNotConfirmDataTable(){
        ...
        ->addColumn('action', function ($report) {
                $act='<a onclick="RequestResponse('.$report->tcnId.')" title="Delete" ><i class="glyphicon glyphicon-remove text-danger"></i></a> &nbsp; ';
                if($report->status=='Approved'){
                    $act.='<a href="#edit" data-id="'.$report->tcnId.'" title="Edit" class="edit_tcn" ><i class="glyphicon glyphicon-edit text-success"></i></a>';
                }
