		...
		<div class="row">
			<div class="panel panel-warning">
				...
				<div class="panel-body">
                  ...
                  <div class="col-md-6 col-xs-12 divTableCell">Heera Account No<b class="data-lab">{{$tcnrequests->heeraaccount->accountNumber}}</b></div>
	...
	<div class="col-lg-12">
		<div class="row">
			<div class="panel panel-default">
				<div class="panel-heading font-bold">REAPPROVAL
				</div>
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-12 text-center">	
							...
							<a href="{{ URL::to('/') }}/admin/tcnApplicationForm/show" class="btn btn-info">Cancel</a>
						</div>
					</div>
				</div>
			</div>
