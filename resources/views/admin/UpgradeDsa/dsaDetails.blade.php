    ...
    <div class="tab-content">
         ...
         <div class="panel panel-default">
          <div class="panel-heading font-bold">Personal Information</div>
           ...
           <div class="col-sm-3">
              ...
              <input type="hidden" class="form-control" id="dsa_code" name="dsa_code" placeholder="" value="{{ $id }}">
              <input type="text" class="form-control" id="emplyee_id" name="emplyee_id" placeholder="" value="{{ $username }}">
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group ">
              ...
              <input type="text" class="form-control" id="name" name="name" value="{{ $dsaDetails->name }}">
              </div>
            ...
            <div class="col-sm-3">
              ...
              <input type="text" class="form-control" id="gname" name="gname" value="{{ $dsaDetails->guardian }}">
            </div>
              </div>
            </div>
            <div class="col-sm-3">
              ...
              <select type="text" class="form-control" id="gender" name="gender">
                ...
                <option value="male" @if($dsaDetails->gender=='male'){{ 'selected' }} @endif>Male</option>
                <option value="female" @if($dsaDetails->gender=='female'){{ 'selected' }} @endif>Female</option>
              </select>
              </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3">
              ...
              <input type="text" class="form-control" id="dob" name="dob" readonly value="{{ date('d-m-Y',strtotime($dsaDetails->dob)) }}">
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
              ...
              <select type="text" class="form-control" id="marital_s" name="marital_s">
                <option value="">Select</option>
                <option value="Married" @if($dsaDetails->maritalStatus=='Married'){{ 'selected' }} @endif>Married</option>
                <option value="Single" @if($dsaDetails->maritalStatus=='Single'){{ 'selected' }} @endif>Single</option>
                <option value="Divorced" @if($dsaDetails->maritalStatus=='Divorced'){{ 'selected' }} @endif>Divorced</option>
                <option value="Other" @if($dsaDetails->maritalStatus=='Other'){{ 'selected' }} @endif>Other</option>
              </select>
              </div>
            </div>
            <div class="col-sm-3">
              ...
              <label for="name">Religion:</label>
               <input type="text" class="form-control" id="religion" name="religion" value="{{ $dsaDetails->religion }}">
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm-3">
              ...
              <select type="text" class="form-control" id="bloodgroup" name="bloodgroup">
                <option value="">Select</option>
                <option value="A+" @if($dsaDetails->bloodGroup=='A+'){{ 'selected' }} @endif>A+</option>
                <option value="A-" @if($dsaDetails->bloodGroup=='A-'){{ 'selected' }} @endif>A-</option>
                <option value="B+" @if($dsaDetails->bloodGroup=='B+'){{ 'selected' }} @endif>B+</option>
                <option value="B-" @if($dsaDetails->bloodGroup=='B-'){{ 'selected' }} @endif>B-</option>
                <option value="AB+" @if($dsaDetails->bloodGroup=='AB+'){{ 'selected' }} @endif>AB+</option>
                <option value="AB-" @if($dsaDetails->bloodGroup=='AB-'){{ 'selected' }} @endif>AB-</option>
                <option value="O+" @if($dsaDetails->bloodGroup=='O+'){{ 'selected' }} @endif>O+</option>
                <option value="O-" @if($dsaDetails->bloodGroup=='O-'){{ 'selected' }} @endif>O-</option>
              </select>
              </div>
            </div>
            <div class="col-sm-3">
              ...
              <select class="form-control" id="nationality" name="nationality" value="{{ $dsaDetails->nationality }}">
                <option value="">Select</option>
                @foreach ($listTypes['country'] as $element)
                  <option value="{{$element->id}}" @if($dsaDetails->countryId==$element->id){{ 'selected' }} @endif>{{$element->countryName}}</option>
                @endforeach
              </select>
              </div>
            </div>
            <div class="col-sm-3">
              ...
              <input type="text" class="form-control" id="mobile" name="mobile" value="{{ $dsaDetails->mobileNumber }}" data-parsley-type="integer" data-parsley-trigger="keyup">
              </div>
            </div>
            <div class="col-sm-3">
              <div class="form-group">
              <label for="name">Email:</label>
              <input type="email" class="form-control" id="email" name="email" value="{{ $dsaDetails->email }}">
              </div>
            </div>
        </div>
        <div class="row">
          <div class="col-sm-3">
              ...
              <select id="proof_type" name="proof_type" class="form-control">
                <option value="">Select</option>
                @foreach ($listTypes['proof_type'] as $proof_types)
                  <option value="{{$proof_types}}" @if($dsaProof->typeOfProof==$proof_types){{ 'selected' }} @endif>{{ucfirst($proof_types)}}</option>
                @endforeach
              </select>
              </div>
            </div>
            <div class="col-sm-3">
              ...
              <input type="text" class="form-control" id="proof_number" name="proof_number" value={{ $dsaProof->proofNumber }}>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-6 " >
                ...
                <div class="col-sm-12">
                  ...
                  <textarea class="form-control" id="c_address" name="c_address">{{$dsaaddress->address}}</textarea> 
                  </div>
                </div>
             </div>
             <div class="row">
                <div class="col-sm-6">
                  ...
                  <label for="name">city:</label>
                   <input type="text" class="form-control" id="c_city" name="c_city" value="{{ $dsaaddress->city }}">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                  <label for="name">State:</label>
                   <input type="text" class="form-control" id="c_state" name="c_state" value="{{ $dsaaddress->state }}">
                  </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <label for="name">Zip Code:</label>
                   <input type="text" class="form-control" id="c_zip" name="c_zip" value="{{ $dsaaddress->pin }}">
                  </div>
                </div>
                </div>
                   @endif
        @endforeach
                ...
                <div class="col-sm-6 seperator">
                  ...
                  <div class="form-group">
                  <label for="name">Address:</label>
                  <textarea class="form-control" id="p_address" name="p_address">{{$dsaaddress->address}}</textarea> 
                  </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                  <label for="name">city:</label>
                   <input type="text" class="form-control" id="p_city" name="p_city" value="{{ $dsaaddress->city }}">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                  <label for="name">State:</label>
                   <input type="text" class="form-control" id="p_state" name="p_state" value="{{ $dsaaddress->state }}">
                  </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                  <label for="name">Zip Code:</label>
                   <input type="text" class="form-control" id="p_zip" name="p_zip" value="{{ $dsaaddress->pin }}">
                  </div>
                </div>
                    @endif
        @endforeach
          ...
          <div class="row">
           ...
           <div class="col-sm-3">
              ...
              <select type="text" class="form-control" id="branch" name="branch">
                <option value="">Select</option>
                @foreach ($listTypes['branch'] as $branches)
            ...
            <div class="col-sm-3">
              ...
              <select type="text" class="form-control" id="designation" name="designation">
                <option value="">Select</option>
                @foreach ($listTypes['designation'] as $designations)
            ...
            fields: {
                'emplyee_id': {
                    validators: {
                        ...
                        remote: {
                            url: '{{URL::to('/') }}/hr/employee/ajax/employee_id_exist',
                    ...
                    // For testing purpose
                     ...
                     $.ajax({
                            ...
                            success: function(data){
                               ...
                               setTimeout(function(){
                                window.location.href='{{URL::to('/') }}/admin/dsaUpgrade';
                                } , 5000);  
                            },
