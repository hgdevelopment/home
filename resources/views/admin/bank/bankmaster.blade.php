             ...
             @endif
              ...
              <div class="col-md-12">
                <div class="col-md-4">
                  ...
                  <input type="text" name="bank_name" class="form-control" value="@yield('bank_name')" placeholder="Enter Bank Name" required data-parsley-required-message="Please Enter Bank Name" data-parsley-pattern="/^[a-zA-Z_ ]*$/" data-parsley-trigger="keyup">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" name="account_number" id="account_number" class="form-control" value="@yield('account_number')"  placeholder="Enter Account Number" required data-parsley-required-message="Please Enter Account Number" data-parsley-minlength="11" data-parsley-pattern="(?:\s*[a-zA-Z0-9]\s*)*" data-parsley-trigger="keyup" onchange="CheckAccNo(this.value)">
                ...
                <div class="col-md-4">
                  <label>BRANCH*</label>
                  <input type="text" name="branch" class="form-control" placeholder="Enter Branch" value="@yield('branch')" required data-parsley-required-message="Please Enter Branch" data-parsley-pattern="(?:\s*[a-zA-Z0-9]\s*)*" data-parsley-trigger="keyup">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" value="@yield('ifsc')"  name="ifsc" class="form-control" placeholder="Enter Ifsc/swift Code" required data-parsley-required-message="Enter IFSC Code" data-parsley-type="alphanum" maxlength="11" minlength="11"  data-parsley-pattern="/^[A-Za-z]{4}\d{7}$/" data-parsley-trigger="keyup">
                  @if ($errors->has('ifsc'))
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" value="@yield('holderName')"  name="holderName" class="form-control" placeholder="Enter Holder Name" id="holderNmae" required data-parsley-required-message="Please Enter Name" data-parsley-pattern="/^[a-zA-Z_ ]*$/" data-parsley-trigger="keyup">
                ...
                <div class="col-md-4">
                  <label>PLACE</label>
                  <input type="text" value="@yield('place')"  name="place" class="form-control" placeholder="Enter Place Name" id="place" data-parsley-pattern="(?:\s*[a-zA-Z0-9]\s*)*" data-parsley-trigger="keyup"> 
                </div>
                <div class="col-md-4">
                  <label>IBAN</label>
                ...
                <tr data-expanded="true">
                  ...
                  <td>
                    ...
                    {{-- <form action="{{ URL::to('/') }}/admin/bankmaster/{{ $banks->id }}" method="POST" class="pull-right">
                      {{ method_field('DELETE') }}
                      {{ csrf_field() }} --}}
                      <button class="active" style="border: none;" onclick="acc_delete({{ $banks->id}})"><i  style="color: #f05050;" class="fa fa-close text-danger text-active" aria-hidden="true"></i></button> 
                   {{--  </form> --}}
                  </td>
                </tr>
              @endforeach
...
function acc_delete(id)
{
  $.ajax({
    type: "get",
    url: "{{URL::to('/') }}/admin/bankmaster/checkAccId",
    data:{accountId:id},
    dataType:'html',
      ...
      if(data!=0) 
      {
        swal({
          ...
          closeOnConfirm: true
            ...
            if (isConfirm) {
             $.ajax({
                url: "{{ URL::to('admin/bankmaster/delete') }}",
                type: "get",
                ...
                success: function (data) {
                  ...
                  setTimeout(function() {
                    window.location.href = "{{ URL::to('admin/bankmaster') }}";
                  }, 1000);
                },
              });
            }
...
function CheckAccNo(accountNo)
{
  ...
  {
    type: "get",
    url: "{{URL::to('/') }}/admin/bankmaster/checkAccNo",
