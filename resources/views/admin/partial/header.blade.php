        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle notificaiton_read">
              ...
              <span class="badge badge-sm up bg-danger pull-right-xs">{{ count(auth('admin')->user()->unreadNotifications) }}</span>
            </a>
            <!-- dropdown -->
            <style type="text/css">
              .unread{
            ...
            <div class="dropdown-menu w-xl animated fadeInUp">
              <div class="panel bg-white">
                <div class="panel-heading b-light bg-light">
                  <strong>You have <span>{{ count(auth('admin')->user()->unreadNotifications) }}</span> notifications</strong>
                </div>
                ...
                @foreach(auth('admin')->user()->notifications()->paginate(4) as $note)
                 {{--  <a href class="list-group-item">
                    ...
                    <span class="clear block m-b-none">
                      {!! $note->data['message'] !!}<br>
                      <small class="text-muted">{{$note->created_at->diffForHumans()}}</small>
                    </span>
                  </a> --}}
                   <a href="{{ URL::to('/').$note->data['url'] }}" class="list-group-item {{ $note->read_at == null ? 'unread' : '' }}">
                    <span class="clear block m-b-none">
                      {!! $note->data['message'] !!}<br>
                      <small class="text-muted">{{$note->created_at->diffForHumans()}}</small>
                    </span>
                ...
                <div class="panel-footer text-sm">
                  ...
                  <a href="{{URL::to('/')}}/admin/allnotification" data-toggle="class:show animated fadeInRight">See all the notifications</a>
                </div>
              </div>
            </div>
            <!-- / dropdown -->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu animated fadeInRight w">
              ...
              <li>
                <a ui-sref="app.page.profile" href="{{ URL::to('/') }}/admin/changePassword">Change Password</a>
              </li>
              <li>
                <a ui-sref="app.docs">
