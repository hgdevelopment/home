            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type='text' name="dateofbirth" id="dateofbirth" required placeholder="MM/DD/YYYY" data-language="en" class="form-control" readonly value="@yield('dateofbirth')" onchange="getAge()"/>
