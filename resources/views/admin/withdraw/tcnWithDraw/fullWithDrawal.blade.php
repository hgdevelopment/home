...
<div class="wrapper bg-white b-b">
      <ul class="nav nav-pills nav-sm">
        <li class="active"><a href="{{ URL::to('/') }}/admin/tcnFullWithDrawal">Request</a></li>
...
<div class="wrapper-md" id="wrapper-md" ng-controller="FormDemoCtrl">
		...
		<div class="panel panel-default">
			<div class="panel-heading font-bold">TCN FULL WITHDRAWAL REQUEST{{-- <a href="{{ URL::to('/') }}/admin/tcnFullWithDrawal/List" class="btn btn-info btn-sm full-right" style="float: right;">LIST</a> --}}</div>
...
{
window.location="{{URL::to('/') }}/admin/tcnFullWithDrawal/view@@@"+tcnId;
}
