...
<div class="bg-light lter b-b wrapper-md">
	...
	<form action="{{ URL::to('/') }}/admin/partialWithdraw/withdraw" method="post" data-parsley-validate >
	{{csrf_field()}}
				...
				<div class="blog-post">                   
					<div class="col-sm-12">
						<div class="panel panel-default">
							...
							<input type="hidden" name="tcn_id" value="{{$datas->tcn_id}}" id="tcn_id">
							{{-- <div class="col-sm-4">
								<label>Applied Date</label>
								<input type="text" id="applied_date" placeholder="MM/DD/YYYY"   class="form-control" name="applied_date"  required>
