      ...
      <div class="blog-post">                   
        <div class="col-md-6 col-md-offset-3">
          <div class="panel panel-info">
            <div class="panel-heading font-bold" style="background-color: #008000;color: #ffffff;border: 1px solid #008000;">VIEW APPLIED LEAVES</div>
              ...
              <div class="row">
                ...
                <div class="col-sm-12"><br></div>
                  <div class="col-sm-12">
                    ...
                    <button type="button" class="btn btn-success" id="approve"><a href="{{ URL::to('/') }}/hr/leave/approve/{{ $leaves->id}}"  class="active"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Approve</button></a>
