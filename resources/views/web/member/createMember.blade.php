...
<form role="form" action="{{URL::to('/') }}/web/member/createMember" method="POST" data-parsley-validate enctype="multipart/form-data">
{{csrf_field()}}
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Full Name" id="fullname" name="fullname" required data-parsley-required-message="Please enter fullname" value="{{ old('fullname') }}">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Father's Name/Husband's Name" id="guardian" name="guardian" value="{{ old('guardian') }}" required data-parsley-required-message="Please enter guardian name" >
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type='text' name="dateofbirth" id="dateofbirth" readonly required data-parsley-required-message="Please enter DOB" placeholder="MM/DD/YYYY" data-language="en" class="form-control" onchange="getAge()" value="{{ old('dateofbirth') }}"/>
                  <div id="dateerror" style="color:red;"></div>
                  {{-- <ul class="parsley-errors-list filled dateerror" id="parsley-id-19" style="display: none"><li class="parsley-required">You must be 18 Years Old.</li></ul> --}}
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <div class="input-group m-b"> 
                    ...
                    <input type="text" placeholder="Income" id="income" name="income" value="{{ old('income') }}" class="form-control" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter income" data-parsley-type="number" data-parsley-min="1">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="No of Children" id="childrens" name="childrens" value="{{ old('childrens') }}" data-parsley-type="number" data-parsley-trigger="keyup">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" placeholder="Email" id="email" name="email" value="{{old('email')}}" required data-parsley-required-message="Please enter email" data-parsley-trigger="change" data-parsley-type="email" data-parsley-trigger="keyup" >
                  @if ($errors->has('email'))
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="form-group">
              ...
              <textarea type="text" class="form-control" placeholder="Address" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter address" id="permanent_addr" name="permanent_addr">{{ old('permanent_addr') }}</textarea>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="City" required data-parsley-required-message="Please enter city" id="permanent_city" name="permanent_city" value="{{ old('permanent_city') }}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="State" required data-parsley-required-message="Please enter state" data-parsley-trigger="keyup" data-parsley-pattern="^[A-Z a-z]*$" id="permanent_state" name="permanent_state" value="{{ old('permanent_state') }}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Pin" required  id="permanent_pin" required data-parsley-trigger="keyup" data-parsley-maxlength="6" data-parsley-minlength="4" data-parsley-required-message="Please enter valid pin" data-parsley-type="integer" name="permanent_pin" value="{{ old('permanent_pin') }}">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="form-group">
              ...
              <textarea type="text" class="form-control" placeholder="Address" id="correspondance_addr" required  name="correspondance_addr" required data-parsley-required-message="Please enter address">{{ old('correspondance_addr') }}</textarea>
            ...
            <div class="form-group">
              <label>City<span style="color:red;">*</span></label>
              <input type="text" class="form-control" placeholder="City" id="correspondance_city" required  name="correspondance_city" value="{{ old('correspondance_city') }}" required data-parsley-required-message="Please enter city">
            ...
            <div class="form-group">
              <label>State<span style="color:red;">*</span></label>
              <input type="text" class="form-control" placeholder="State" id="correspondance_state" required name="correspondance_state" value="{{ old('correspondance_state') }}" required data-parsley-required-message="Please enter state" data-parsley-pattern="^[A-Z a-z]*$" data-parsley-trigger="keyup">
      ...
      <div class="col-sm-4">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="form-group">
              <label>Address</label>
              <textarea type="text" class="form-control" placeholder="Address" id="official_addr" name="official_addr">{{ old('official_addr') }}</textarea>
              @if ($errors->has('official_addr'))
              <span class="help-inline">{{$errors->first('official_addr')}}</span>
              @endif
            </div>
            <div class="form-group">
              <label>City</label>
              <input type="text" class="form-control" placeholder="City" id="official_city" name="official_city" value="{{ old('official_city') }}">
              @if ($errors->has('official_city'))
              <span class="help-inline">{{$errors->first('official_city')}}</span>
              @endif
            </div>
            <div class="form-group">
              <label>State</label>
              <input type="text" class="form-control" placeholder="State" id="official_state" name="official_state" data-parsley-pattern="^[A-Z a-z]*$" data-parsley-trigger="keyup" value="{{ old('official_state') }}">
              @if ($errors->has('official_state'))
              <span class="help-inline">{{$errors->first('official_state')}}</span>
              @endif
            </div>
            <div class="form-group">
              <label>Country</label>
            ...
            <div class="form-group">
              <label>Pin</label>
              <input type="text" class="form-control" placeholder="Pin" id="official_pin" name="official_pin" data-parsley-type="integer" data-parsley-trigger="keyup" data-parsley-maxlength="6" data-parsley-required-message="Please enter valid pin" data-parsley-minlength="4" value="{{ old('official_pin') }}">
              @if ($errors->has('official_pin'))
              <span class="help-inline">{{$errors->first('official_pin')}}</span>
              @endif
            </div>
          </div>
        </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Amount  Applying For" id="amount_inr" data-parsley-type="number" name="amount_inr" value="{{ old('amount_inr') }}" >
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>Amount  Applying For</label>
                    <input type="text" class="form-control" placeholder="Amount  Applying For" id="amount_aed" name="amount_aed" data-parsley-type="number" value="{{ old('amount_aed') }}">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>Amount  Applying For</label>
                    <input type="text" class="form-control" placeholder="Amount  Applying For " id="amount_usd" name="amount_usd" data-parsley-type="number" value="{{ old('amount_usd') }}">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>Amount  Applying For</label>
                    <input type="text" class="form-control" placeholder="Amount  Applying For " id="amount_sar" name="amount_sar" data-parsley-type="number" value="{{ old('amount_sar') }}">
                ...
                <div class="col-sm-6">
                  <div class="form-group"> 
                    <label>Amount  Applying For</label>
                    <input type="text" class="form-control" placeholder="Amount  Applying For" id="amount_cad" name="amount_cad" data-parsley-type="number" value="{{ old('amount_cad') }}">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control" placeholder="ID Number" id="proof_number" name="proof_number"  value="{{ old('proof_number') }}"  data-parsley-required-message="Please enter ID Number">
...
<script src="{{ URL::asset('js/bootstrap-parsley.min.js') }}"></script>
