             ...
             @endphp
              ...
              <td>
                  ...
                  @if(count($WithDrawApplied)>0)
                    <a title="View" href="{{ url('web/tcnwithDrawal/view@@@'.$wd->id) }}"><span class="text-primary" >Withdrawal Request is Sent</span></a>
                  @else
                    @if($element->paymentReceived=='Received' && count($WithDrawApplied==0) && $unlockdate<=date("Y-m-d")  && ($element->unit>$WithDrawPaid))
                    ...
                    @endif
                    @if($wd->status=='Paid')
                      <a title="View" href="{{ url('web/tcnwithDrawal/view@@@'.$wd->id) }}"><span class="text-primary" >Withdrawal Request is Approved</span></a>
                    @endif
                  @endif 
              </td>
