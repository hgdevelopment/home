...
@include('web.partial.profileheader')
  ...
  <div class="panel panel-warning">
    ...
    <div class="col-sm-4 font-bold text-success h4">TCN : <span class="text-danger">{{$tcnrequests->tcn->tcnType}}</span></div><div class="col-sm-4 font-bold text-success h4">WITHDARW STATUS : <span class="text-danger">{{$withDraws->status}}</span></div>&nbsp;
    </div>
  </div>
