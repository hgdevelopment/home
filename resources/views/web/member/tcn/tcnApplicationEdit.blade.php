      ...
      <div class="panel panel-default">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <select name="tcn" id="tcn" class="form-control"    data-parsley-required-message="TCN is required" required {{($tcnrequest->status=='notConfirm')?'readonly':''}}>
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="form-group">
              ...
              <select name="curency_type" id="curency_type" class="form-control" data-parsley-required-message="Please Select Currency Type" required {{($tcnrequest->status=='notConfirm')?'readonly':''}}>
                <option value="">Select</option>
           ...
           <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="No of Units"  name="no_of_units" id="no_of_units" value="{{ $tcnrequest->unit }}" data-parsley-required-message="No of Units is required" required {{($tcnrequest->status=='notConfirm')?'readonly':''}}>
          ...
          <div class="col-sm-4">
            <div class="form-group">
              <label>Amount</label>
              <input type="text" class="form-control" placeholder="Amount"  name="amount" id="amount" value="{{$tcnrequest->amount}}" readonly data-parsley-required-message="Amount is required" required {{($tcnrequest->status=='notConfirm')?'readonly':''}}>
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <select name="pay_mode" id="pay_mode" class="form-control" data-parsley-required-message="Pay Mode is required" required {{($tcnrequest->status=='notConfirm')?'readonly':''}}>
              <option value="">Select</option>
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control"  name="heera_account" id="heera_account"  data-parsley-required-message="Heera Account No is required" required {{($tcnrequest->status=='notConfirm')?'readonly':''}}>
              </select>
            </div>
            </div>
        </div>
...
<script  type="text/javascript" >
  $(function(){
    ...
    if('{{$tcnrequest->status}}'=='notConfirm'){
       $('#deposite_date').val('');
