          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                <img src="{{ URL::asset('/storage/img/member_img/'.$userProfile->photo)}}" alt="...">
                <i class="on md b-white bottom"></i>
              </span>
              <span class="hidden-sm hidden-md">{{$userProfile->name}}</span> <b class="caret"></b>
            </a>
            <!-- dropdown -->
            <ul class="dropdown-menu animated fadeInRight w">
              ...
              <li class="divider"></li>
              <li>
                <a href="{{ URL::to('/') }}/web/changePassword">Change Password</a>
              </li>
              <li>
